...
public class Frontend
{
	...
	final public static int SFX_CAMERA		= frontend:0x0077r;
	...
	{
		if( Config.video_x >= 2560 || Config.video_y >= 1440 )
		{
			largeFont  = new ResourceRef( Text.RID_SLII48 );
			mediumFont = new ResourceRef( Text.RID_SLII48 );	//check carinfo!
			smallFont  = new ResourceRef( Text.RID_SLII34 );
			pointers = new ResourceRef( Text.RID_SYM_POINTERS4K );
			Config.SysCursor = 0;
		}
		else
		if( Config.video_x >= 1024 || Config.video_y >= 768 )
		{
		...
		if( Config.video_x >= 320 || Config.video_y >= 240 )
		{
