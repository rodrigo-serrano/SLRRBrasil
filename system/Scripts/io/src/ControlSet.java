...
//System.log( i+" dev "+deviceID [i]+" ax "+axisID [i]+" fmin "+from_min [i]+" fmax "+from_max [i]+" tmin "+to_min [i]+" tmax "+to_max [i]+" dz "+dead_zone [i]);
	...
	public void defaults()
	{
		...
		define ( 2, 1, Input.AXIS_TURN_LEFTRIGHT, KEYBOARD, Input.RCDIK_A, 0.0, 1.0, 0.0, 1.0, Config.deadZoneSteering );
		define ( 3, 1, Input.AXIS_TURN_LEFTRIGHT, KEYBOARD, Input.RCDIK_D, 0.0, 1.0, 0.0, -1.0, Config.deadZoneSteering );

		define ( 4, 1, Input.AXIS_HANDBRAKE, KEYBOARD, Input.RCDIK_SPACE, 0.0, 1.0, 0.0, 1.0, 0.0 );
		define ( 5, 1, Input.AXIS_GEAR_UPDOWN, KEYBOARD, Input.RCDIK_Z, 0.0, 200.0, 0.0, 200.0, 0.0 );
		define ( 6, 1, Input.AXIS_GEAR_UPDOWN, KEYBOARD, Input.RCDIK_X, 0.0, 200.0, 0.0, -200.0, 0.0 );
		define ( 7, 1, Input.AXIS_CLUTCH, KEYBOARD, Input.RCDIK_C, 0.0, 200.0, 0.0, 200.0, Config.deadZoneClutch );
		define ( 8, 1, Input.AXIS_NITRO, KEYBOARD, Input.RCDIK_W, 0.0, 1.0, 0.0, 1.0, 0.0 );
		...
		define (79, 0, Input.AXIS_MUSIC_SELECT_NEXT, KEYBOARD, Input.RCDIK_PERIOD, 0.0, 1.0, 0.0, 1.0, 0.0 );
		define (80, 0, Input.AXIS_MUSIC_SELECT_PREV, KEYBOARD, Input.RCDIK_COMMA, 0.0, 1.0, 0.0, 1.0, 0.0 );
		define (81, 0, Input.AXIS_MUSIC_VOLUME_UP, KEYBOARD, Input.RCDIK_NUMPADSTAR, 0.0, 1.0, 0.0, 1.0, 0.0 );
		define (82, 0, Input.AXIS_MUSIC_VOLUME_DOWN, KEYBOARD, Input.RCDIK_NUMPADSLASH, 0.0, 1.0, 0.0, 1.0, 0.0 );
		define (83, 1, Input.AXIS_HELP, KEYBOARD, Input.RCDIK_S, 0.0, 1.0, 0.0, 1.0, 0.0 ); // Cruise control
		define (84, 1, Input.AXIS_LOOK_REAR, KEYBOARD, Input.RCDIK_B, 0.0, 1.0, 0.0, 1.0, 0.0 );
		define (85, 1, Input.AXIS_MAP, KEYBOARD, Input.RCDIK_M, 0.0, 1.0, 0.0, 1.0, 0.0 );
		define (86, 0, Input.AXIS_PRINTSCREEN, KEYBOARD, Input.RCDIK_F12, 0.0, 1.0, 0.0, 1.0, 0.0 );
	}
