...
public class Trigger
{
	...
	public Trigger( GameRef parent, GameRef type, Vector3 pos, Ypr ori, float x, float y, float z, String alias)
	{
		if( type == null )
			type = new GameRef( DEFAULT );

		trigger = new GameRef(parent, type.id(), pos.toString() +","+ori.toString()+",box,"+ x +","+ y +","+ z, alias);
		this.pos = pos;
		this.ori = ori;
		this.alias = alias;
	}
