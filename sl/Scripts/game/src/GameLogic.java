...
public class GameLogic extends GameType implements Runnable
{
	...
	public GameLogic()
	{
		...
		CLUBNAMES[0] = "Documento Verde";
		CLUBNAMES[1] = "Guepardo Azul";
		CLUBNAMES[2] = "Chama Vermelha";
...
//----------------------------------------------------------------------
	...
	public static int autoSave()
	{
		if( played && !saved )
		{
			...
			{
				new WarningDialog( player.controller, Dialog.DF_MODAL|Dialog.DF_DEFAULTBG, "Informacao", "Voce esta saindo da sua Campanha atual. \n Sua Campanha foi salva Automaticamente.." ).display();
