...
//			changeCamFollow();
	...
	public int selectNrOpponent()
	{
		...
		if(nrOpponents.size() != 0)
		{
			...
			{
				new WarningDialog(player.controller, Dialog.DF_MODAL|Dialog.DF_DEFAULTBG, "SEM DINHEIRO", "Cara, não vamos te dar um bolsa familia para participar! \n Arranja pelo menos R$" + player.getMinBet() + " e então podemos conversar.").display();
			}
			else
			{
		...
		else new WarningDialog(player.controller, Dialog.DF_MODAL|Dialog.DF_DEFAULTBG, "SEM OPONENTES", "Desculpe, nao ha oponentes contra os quais correr. \n Volte mais tarde!").display();
