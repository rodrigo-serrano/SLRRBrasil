...
public class Tachometer_Shift_Light extends DecorativeBodyPart
{
	Thread AnimateThread;
	
	public Tachometer_Shift_Light( int id )
	{
		super( id );
		name = "Cronomac Shift Light (yellow)";
		description = "Glow color: Yellow";
		...
		AnimateThread.start();
       		...
       		addPart( parts.Tachometer_pack:0x0000001Er, "pin" );
	...
	public void LightUp()
	{
		...
		float flashlimit = (limiter-250.0);
