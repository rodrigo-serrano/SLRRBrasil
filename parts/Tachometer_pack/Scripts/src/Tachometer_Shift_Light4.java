...
public class Tachometer_Shift_Light4 extends DecorativeBodyPart
{
	Thread AnimateThread;
	
	public Tachometer_Shift_Light4( int id )
	{
		super( id );
		name = "Cronomac Shift Light (red)";
		description = "Glow color: Red";
		...
		AnimateThread.start();
       		...
       		addPart( parts.Tachometer_pack:0x0000004Er, "pin" );
