...
public class Tachometer_Shift_Light5 extends DecorativeBodyPart
{
	Thread AnimateThread;
	float throttle;

	public Tachometer_Shift_Light5( int id )
	{
		super( id );
		name = "Cronomac Shift Light (orange)";
		description = "Glow color: Orange";
		...
		AnimateThread.start();
       		...
       		addPart( parts.Tachometer_pack:0x0000005Er, "pin" );
