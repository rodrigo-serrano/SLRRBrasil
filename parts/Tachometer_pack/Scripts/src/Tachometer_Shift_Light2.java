...
public class Tachometer_Shift_Light2 extends DecorativeBodyPart
{
	Thread AnimateThread;
	
	public Tachometer_Shift_Light2( int id )
	{
		super( id );
		name = "Cronomac Shift Light (blue)";
		description = "Glow color: Blue";
		...
		AnimateThread.start();
       		...
       		addPart( parts.Tachometer_pack:0x0000002Er, "pin" );
