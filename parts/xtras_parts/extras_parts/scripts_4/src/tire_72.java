...
public class tire_72 extends Gorgoil_Tyre
{
	public tire_72 ( int id )
	{
		...
		render_types[0]  = parts.xtras_parts:0x1BDr;		// for  3.0 inch wide rims //
		render_types[1]  = parts.xtras_parts:0x1BDr;		// for  3.5 inch wide rims //
		render_types[2]  = parts.xtras_parts:0x1BEr;		// for  4.0 inch wide rims //
		render_types[3]  = parts.xtras_parts:0x1BEr;		// for  4.5 inch wide rims //
		render_types[4]  = parts.xtras_parts:0x1BFr;		// for  5.0 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x1BDr;		// this rendertype as default //
