...
public class tire_69 extends Gorgoil_Tyre
{
	public tire_69 ( int id )
	{
		...
		render_types[14] = parts.extras_parts:0x1BAr;		// for 10.0 inch wide rims //
		render_types[15] = parts.extras_parts:0x1BAr;		// for 10.5 inch wide rims //
		render_types[16] = parts.extras_parts:0x1BAr;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1BAr;		// this rendertype as default //

		SetupTyre(275.0, 50.0, 15.0, 10.0, tcDOTDRAG, 2.0);

		name= "Hoosier Dot Drag Radial 275/50R15";
