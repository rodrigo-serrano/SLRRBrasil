...
public class tire_75 extends Gorgoil_Tyre
{
	public tire_75 ( int id )
	{
		...
		render_types[0]  = parts.xtras_parts:0x1C0r;		// for  3.0 inch wide rims //
		render_types[1]  = parts.xtras_parts:0x1C0r;		// for  3.5 inch wide rims //
		render_types[2]  = parts.xtras_parts:0x1C1r;		// for  4.0 inch wide rims //
		render_types[3]  = parts.xtras_parts:0x1C1r;		// for  4.5 inch wide rims //
		render_types[4]  = parts.xtras_parts:0x1C2r;		// for  5.0 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x1C0r;		// this rendertype as default //
