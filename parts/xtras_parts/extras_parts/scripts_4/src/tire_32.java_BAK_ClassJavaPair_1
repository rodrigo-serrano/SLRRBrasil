...
public class tire_32 extends Gorgoil_Tyre
{
	public tire_32 ( int id )
	{
		...
		render_types[24] = parts.extras_parts:0x195r;		// for 15.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x195r;		// this rendertype as default //

		SetupTyre(330.0, 65.0, 15.0, 15.0, tcSLICK, 2.0);

		name= "Mickey Thompson 34x15x15 slick";
