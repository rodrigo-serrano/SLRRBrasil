...
public class tire_17 extends Gorgoil_Tyre
{
	public tire_17 ( int id )
	{
		...
		render_types[14] = parts.xtras_parts:0x186r;		// for 10.0 inch wide rims //
		render_types[15] = parts.xtras_parts:0x186r;		// for 10.5 inch wide rims //
		render_types[16] = parts.xtras_parts:0x253r;		// for 11.0 inch wide rims //
		render_types[17] = parts.xtras_parts:0x253r;		// for 11.5 inch wide rims //
		render_types[18] = parts.xtras_parts:0x256r;		// for 12.0 inch wide rims //
		render_types[19] = parts.xtras_parts:0x256r;		// for 12.5 inch wide rims //
		render_types[20] = parts.xtras_parts:0x187r;		// for 13.0 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x187r;		// this rendertype as default //
