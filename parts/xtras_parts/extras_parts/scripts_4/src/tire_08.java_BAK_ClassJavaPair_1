...
public class tire_08 extends Gorgoil_Tyre
{
	public tire_08 ( int id )
	{
		...
		render_types[12] = parts.extras_parts:0x17Dr;		// for 9.0 inch wide rims //
		render_types[13] = parts.extras_parts:0x17Dr;		// for 9.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x17Dr;		// this rendertype as default //

		SetupTyre(235.0, 60.0, 15.0, 9.0, tcDOTDRAG, 2.0);

		name= "Hoosier Dot Drag Radial 235/60R15";
