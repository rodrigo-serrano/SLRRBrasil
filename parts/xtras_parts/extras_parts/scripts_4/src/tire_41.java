...
public class tire_41 extends Gorgoil_Tyre
{
	public tire_41 ( int id )
	{
		...
		render_types[19] = parts.xtras_parts:0x19Er;		// for 12.5 inch wide rims //
		render_types[20] = parts.xtras_parts:0x19Er;		// for 13.0 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x19Er;		// this rendertype as default //
