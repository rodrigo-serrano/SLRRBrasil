...
public class tire_90 extends Gorgoil_Tyre
{
	public tire_90 ( int id )
	{
		...
		render_types[16] = parts.extras_parts:0x26Dr;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x26Dr;		// this rendertype as default //
