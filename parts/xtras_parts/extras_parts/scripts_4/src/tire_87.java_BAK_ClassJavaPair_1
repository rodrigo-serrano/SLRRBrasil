...
public class tire_87 extends Gorgoil_Tyre
{
	public tire_87 ( int id )
	{
		tyre_size_label = "280/60 R15";
		...
		render_types[16] = parts.extras_parts:0x261r;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x261r;		// this rendertype as default //

		SetupTyre(280.0, 60.0, 15.0, 11.0, tcSLICK, 2.0);

		name= "GoodYear 28x11x15 slick";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(280.0, 60.0, 15.0, rim.rim_width, tcSLICK);
