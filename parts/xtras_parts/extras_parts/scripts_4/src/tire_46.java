...
public class tire_46 extends Gorgoil_Tyre
{
	public tire_46 ( int id )
	{
		...
		render_types[10] = parts.xtras_parts:0x1A3r; 		// for 8.0 inch wide rims //
		render_types[11] = parts.xtras_parts:0x1A3r;		// for 8.5 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x1A3r;		// this rendertype as default //
