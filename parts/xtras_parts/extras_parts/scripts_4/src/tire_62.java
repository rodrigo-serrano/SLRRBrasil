...
public class tire_62 extends Gorgoil_Tyre
{
	public tire_62 ( int id )
	{
		...
		render_types[19] = parts.xtras_parts:0x1B3r;		// for 12.5 inch wide rims //
		render_types[20] = parts.xtras_parts:0x1B3r;		// for 13.0 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x1B3r;		// this rendertype as default //
