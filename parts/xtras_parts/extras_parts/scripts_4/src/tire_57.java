...
public class tire_57 extends Gorgoil_Tyre
{
	public tire_57 ( int id )
	{
		...
		render_types[0]  = parts.xtras_parts:0x1AEr;		// for  3.0 inch wide rims //
		render_types[1]  = parts.xtras_parts:0x1AEr;		// for  3.5 inch wide rims //
		render_types[2]  = parts.xtras_parts:0x1AFr;		// for  4.0 inch wide rims //
		render_types[3]  = parts.xtras_parts:0x1AFr;		// for  4.5 inch wide rims //
		render_types[4]  = parts.xtras_parts:0x1B0r;		// for  5.0 inch wide rims //
		render_types[5]  = parts.xtras_parts:0x1B0r;		// for  5.5 inch wide rims //
		render_types[6]  = parts.xtras_parts:0x1B1r;		// for  6.0 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x1AEr;		// this rendertype as default //
