...
public class tire_38 extends Gorgoil_Tyre
{
	public tire_38 ( int id )
	{
		...
		render_types[10] = parts.xtras_parts:0x19Br; 		// for 8.0 inch wide rims //
		render_types[11] = parts.xtras_parts:0x19Br;		// for 8.5 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x19Br;		// this rendertype as default //
