...
public class tire_70 extends Gorgoil_Tyre
{
	public tire_70 ( int id )
	{
		...
		render_types[10] = parts.xtras_parts:0x1BBr; 		// for 8.0 inch wide rims //
		render_types[11] = parts.xtras_parts:0x1BBr;		// for 8.5 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x1BBr;		// this rendertype as default //
