...
public class tire_57 extends Gorgoil_Tyre
{
	public tire_57 ( int id )
	{
		tyre_size_label = "115/95 R17";
		
		render_types = new int[30];
		render_types[0]  = parts.extras_parts:0x1AEr;		// for  3.0 inch wide rims //
		render_types[1]  = parts.extras_parts:0x1AEr;		// for  3.5 inch wide rims //
		render_types[2]  = parts.extras_parts:0x1AFr;		// for  4.0 inch wide rims //
		render_types[3]  = parts.extras_parts:0x1AFr;		// for  4.5 inch wide rims //
		render_types[4]  = parts.extras_parts:0x1B0r;		// for  5.0 inch wide rims //
		render_types[5]  = parts.extras_parts:0x1B0r;		// for  5.5 inch wide rims //
		render_types[6]  = parts.extras_parts:0x1B1r;		// for  6.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1AEr;		// this rendertype as default //

		SetupTyre(115.0, 95.0, 17.0, 3.0, tcETRUNNER, 2.0);

		name= "Goodyear ET Runners 26x4x17";
