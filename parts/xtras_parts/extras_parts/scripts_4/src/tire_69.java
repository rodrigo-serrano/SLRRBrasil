...
public class tire_69 extends Gorgoil_Tyre
{
	public tire_69 ( int id )
	{
		...
		render_types[14] = parts.xtras_parts:0x1BAr;		// for 10.0 inch wide rims //
		render_types[15] = parts.xtras_parts:0x1BAr;		// for 10.5 inch wide rims //
		render_types[16] = parts.xtras_parts:0x1BAr;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x1BAr;		// this rendertype as default //
