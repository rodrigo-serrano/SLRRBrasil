...
public class tire_06 extends Gorgoil_Tyre
{
	public tire_06 ( int id )
	{
		...
		render_types[26] = parts.extras_parts:0x17Br;		// for 16.0 inch wide rims //
		render_types[27] = 0;		// for 16.5 inch wide rims //
		render_types[28] = 0;		// for 17.0 inch wide rims //
		render_types[29] = parts.extras_parts:0x17Br;		// this rendertype as default //
