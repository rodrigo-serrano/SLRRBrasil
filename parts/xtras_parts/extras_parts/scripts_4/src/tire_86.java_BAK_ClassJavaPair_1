...
public class tire_86 extends Gorgoil_Tyre
{
	public tire_86 ( int id )
	{
		...
		render_types[16] = parts.extras_parts:0x25Dr;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x25Dr;		// this rendertype as default //

		SetupTyre(280.0, 75.0, 15.0, 11.0, tcSLICK, 2.0);

		name= "Hoosier 32x11x15 slick";
