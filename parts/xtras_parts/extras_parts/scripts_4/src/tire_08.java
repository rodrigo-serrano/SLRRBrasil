...
public class tire_08 extends Gorgoil_Tyre
{
	public tire_08 ( int id )
	{
		...
		render_types[12] = parts.xtras_parts:0x17Dr;		// for 9.0 inch wide rims //
		render_types[13] = parts.xtras_parts:0x17Dr;		// for 9.5 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x17Dr;		// this rendertype as default //
