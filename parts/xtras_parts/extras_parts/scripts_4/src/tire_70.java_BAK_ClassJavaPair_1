...
public class tire_70 extends Gorgoil_Tyre
{
	public tire_70 ( int id )
	{
		...
		render_types[10] = parts.extras_parts:0x1BBr; 		// for 8.0 inch wide rims //
		render_types[11] = parts.extras_parts:0x1BBr;		// for 8.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1BBr;		// this rendertype as default //

		SetupTyre(225.0, 50.0, 16.0, 8.0, tcDOTDRAG, 2.0);

		name= "Hoosier Dot Drag Radial 225/50R16";
