...
public class tire_36 extends Gorgoil_Tyre
{
	public tire_36 ( int id )
	{
		...
		render_types[12] = parts.xtras_parts:0x199r;		// for 9.0 inch wide rims //
		render_types[13] = parts.xtras_parts:0x199r;		// for 9.5 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x199r;		// this rendertype as default //
