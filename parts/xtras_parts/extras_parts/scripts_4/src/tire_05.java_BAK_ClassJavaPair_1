...
public class tire_05 extends Gorgoil_Tyre
{
	public tire_05( int id )
	{
		...
		render_types[26] = parts.extras_parts:0x17Ar;		// for 16.0 inch wide rims //
		render_types[27] = 0;		// for 16.5 inch wide rims //
		render_types[28] = 0;		// for 17.0 inch wide rims //
		render_types[29] = parts.extras_parts:0x17Ar;		// this rendertype as default //

		SetupTyre(405.0, 40.0, 15.0, 16.0, tcSLICK, 2.0);

		name= "Hoosier 28x16x15 slick";
		name_prefix = "Hoosier";
