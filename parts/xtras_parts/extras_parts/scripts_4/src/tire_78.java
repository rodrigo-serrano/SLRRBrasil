...
public class tire_78 extends Gorgoil_Tyre
{
	public tire_78 ( int id )
	{
		...
		render_types[0]  = parts.xtras_parts:0x1C3r;		// for  3.0 inch wide rims //
		render_types[1]  = parts.xtras_parts:0x1C3r;		// for  3.5 inch wide rims //
		render_types[2]  = parts.xtras_parts:0x1C4r;		// for  4.0 inch wide rims //
		render_types[3]  = parts.xtras_parts:0x1C4r;		// for  4.5 inch wide rims //
		render_types[4]  = parts.xtras_parts:0x1C5r;		// for  5.0 inch wide rims //
		render_types[5]  = parts.xtras_parts:0x1C5r;		// for  5.5 inch wide rims //
		render_types[6]  = parts.xtras_parts:0x1C6r;		// for  6.0 inch wide rims //
