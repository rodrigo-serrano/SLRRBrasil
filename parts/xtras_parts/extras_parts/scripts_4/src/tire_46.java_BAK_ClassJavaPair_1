...
public class tire_46 extends Gorgoil_Tyre
{
	public tire_46 ( int id )
	{
		...
		render_types[10] = parts.extras_parts:0x1A3r; 		// for 8.0 inch wide rims //
		render_types[11] = parts.extras_parts:0x1A3r;		// for 8.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1A3r;		// this rendertype as default //

		SetupTyre(225.0, 50.0, 15.0, 8.0, tcDOTDRAG, 2.0);

		name= "GoodYear Dot Drag Radial 225/50R15";
