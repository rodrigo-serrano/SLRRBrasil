...
public class tire_50 extends Gorgoil_Tyre
{
	public tire_50 ( int id )
	{
		...
		render_types[14] = parts.xtras_parts:0x1A7r;		// for 10.0 inch wide rims //
		render_types[15] = parts.xtras_parts:0x1A7r;		// for 10.5 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x1A7r;		// this rendertype as default //
