...
public class tire_12 extends Gorgoil_Tyre
{
	public tire_12 ( int id )
	{
		...
		render_types[10] = parts.xtras_parts:0x181r; 		// for 8.0 inch wide rims //
		render_types[11] = parts.xtras_parts:0x181r;		// for 8.5 inch wide rims //
		render_types[12] = parts.xtras_parts:0x182r;		// for 9.0 inch wide rims //
		render_types[13] = parts.xtras_parts:0x182r;		// for 9.5 inch wide rims //
		render_types[14] = parts.xtras_parts:0x183r;		// for 10.0 inch wide rims //
		render_types[15] = parts.xtras_parts:0x183r;		// for 10.5 inch wide rims //
		render_types[16] = parts.xtras_parts:0x184r;		// for 11.0 inch wide rims //
		render_types[17] = parts.xtras_parts:0x184r;		// for 11.5 inch wide rims //
		render_types[18] = parts.xtras_parts:0x250r;		// for 12.0 inch wide rims //
		render_types[19] = parts.xtras_parts:0x250r;		// for 12.5 inch wide rims //
		render_types[20] = parts.xtras_parts:0x185r;		// for 13.0 inch wide rims //
		...
		render_types[29] = parts.xtras_parts:0x181r;		// this rendertype as default //
