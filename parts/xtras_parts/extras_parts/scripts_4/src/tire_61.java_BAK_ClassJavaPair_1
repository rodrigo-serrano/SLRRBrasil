...
public class tire_61 extends Gorgoil_Tyre
{
	public tire_61 ( int id )
	{
		...
		render_types[14] = parts.extras_parts:0x1B2r;		// for 10.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1B2r;		// this rendertype as default //
