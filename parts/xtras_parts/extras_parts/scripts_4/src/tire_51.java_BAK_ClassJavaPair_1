...
public class tire_51 extends Gorgoil_Tyre
{
	public tire_51 ( int id )
	{
		tyre_size_label = "115/80 R15";
		
		render_types = new int[30];
		render_types[0]  = parts.extras_parts:0x1A8r;		// for  3.0 inch wide rims //
		render_types[1]  = parts.extras_parts:0x1A8r;		// for  3.5 inch wide rims //
		render_types[2]  = parts.extras_parts:0x1A9r;		// for  4.0 inch wide rims //
		render_types[3]  = parts.extras_parts:0x1A9r;		// for  4.5 inch wide rims //
		render_types[4]  = parts.extras_parts:0x1AAr;		// for  5.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1A8r;		// this rendertype as default //

		SetupTyre(115.0, 80.0, 15.0, 3.0, tcETRUNNER, 2.0);

		name= "GoodYear ET Runner 22.5x4.5x15";
