...
public class tire_07 extends Gorgoil_Tyre
{
	public tire_07 ( int id )
	{
		...
		render_types[10] = parts.extras_parts:0x17Cr; 		// for 8.0 inch wide rims //
		render_types[11] = parts.extras_parts:0x17Cr;		// for 8.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x17Cr;		// this rendertype as default //
