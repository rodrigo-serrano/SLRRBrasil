...
public class tire_42 extends Gorgoil_Tyre
{
	public tire_42 ( int id )
	{
		...
		render_types[24] = parts.extras_parts:0x19Fr;		// for 15.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x19Fr;		// this rendertype as default //

		SetupTyre(380.0, 45.0, 15.0, 15.0, tcSLICK, 2.0);

		name= "GoodYear 28x15x15 slick";
