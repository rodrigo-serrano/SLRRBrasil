...
public class tire_67 extends Gorgoil_Tyre
{
	public tire_67 ( int id )
	{
		...
		render_types[10] = parts.extras_parts:0x1B8r; 		// for 8.0 inch wide rims //
		render_types[11] = parts.extras_parts:0x1B8r;		// for 8.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1B8r;		// this rendertype as default //
