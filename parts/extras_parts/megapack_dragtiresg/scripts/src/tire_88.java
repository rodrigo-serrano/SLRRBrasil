...
public class tire_88 extends Gorgoil_Tyre
{
	public tire_88 ( int id )
	{
		tyre_size_label = "280/75 R15";
		...
		render_types[16] = parts.extras_parts:0x265r;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x265r;		// this rendertype as default //

		SetupTyre(280.0, 75.0, 15.0, 11.0, tcSLICK, 2.0);

		name= "Goodyear 32x11x15 slick";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(280.0, 75.0, 15.0, rim.rim_width, tcSLICK);
