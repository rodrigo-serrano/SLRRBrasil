...
public class tire_22 extends Gorgoil_Tyre
{
	public tire_22 ( int id )
	{
		tyre_size_label = "115/80 R16";
		
		render_types = new int[30];
		render_types[0]  = parts.extras_parts:0x18Br;		// for  3.0 inch wide rims //
		render_types[1]  = parts.extras_parts:0x18Br;		// for  3.5 inch wide rims //
		render_types[2]  = parts.extras_parts:0x18Cr;		// for  4.0 inch wide rims //
		render_types[3]  = parts.extras_parts:0x18Cr;		// for  4.5 inch wide rims //
		render_types[4]  = parts.extras_parts:0x18Dr;		// for  5.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x18Br;		// this rendertype as default //
