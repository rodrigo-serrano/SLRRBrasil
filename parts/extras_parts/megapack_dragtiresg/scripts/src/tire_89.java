...
public class tire_89 extends Gorgoil_Tyre
{
	public tire_89 ( int id )
	{
		...
		render_types[16] = parts.extras_parts:0x269r;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x269r;		// this rendertype as default //
