...
public class tire_02 extends Gorgoil_Tyre
{
	public tire_02 ( int id )
	{
		...
		render_types[19] = parts.extras_parts:0x177r;		// for 12.5 inch wide rims //
		render_types[20] = parts.extras_parts:0x177r;		// for 13.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x177r;		// this rendertype as default //
