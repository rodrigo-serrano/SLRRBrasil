...
public class tire_37 extends Gorgoil_Tyre
{
	public tire_37 ( int id )
	{
		tyre_size_label = "275/50 R15";
		...
		render_types[14] = parts.extras_parts:0x19Ar;		// for 10.0 inch wide rims //
		render_types[15] = parts.extras_parts:0x19Ar;		// for 10.5 inch wide rims //
		render_types[16] = parts.extras_parts:0x19Ar;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x19Ar;		// this rendertype as default //

		SetupTyre(275.0, 50.0, 15.0, 10.0, tcDOTDRAG, 2.0);

		name= "Mickey Thompson Dot Drag Radial 275/50R15";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(275.0, 50.0, 15.0, rim.rim_width, tcDOTDRAG);
