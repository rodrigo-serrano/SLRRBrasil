...
public class tire_31 extends Gorgoil_Tyre
{
	public tire_31 ( int id )
	{
		tyre_size_label = "380/45 R15";
		...
		render_types[24] = parts.extras_parts:0x194r;		// for 15.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x194r;		// this rendertype as default //

		SetupTyre(380.0, 45.0, 15.0, 15.0, tcSLICK, 2.0);

		name= "Mickey Thompson 28x15x15 slick";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(380.0, 45.0, 15.0, rim.rim_width, tcSLICK);
