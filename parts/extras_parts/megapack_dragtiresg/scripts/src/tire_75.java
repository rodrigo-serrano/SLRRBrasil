...
public class tire_75 extends Gorgoil_Tyre
{
	public tire_75 ( int id )
	{
		tyre_size_label = "115/80 R16";
		
		render_types = new int[30];
		render_types[0]  = parts.extras_parts:0x1C0r;		// for  3.0 inch wide rims //
		render_types[1]  = parts.extras_parts:0x1C0r;		// for  3.5 inch wide rims //
		render_types[2]  = parts.extras_parts:0x1C1r;		// for  4.0 inch wide rims //
		render_types[3]  = parts.extras_parts:0x1C1r;		// for  4.5 inch wide rims //
		render_types[4]  = parts.extras_parts:0x1C2r;		// for  5.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1C0r;		// this rendertype as default //

		SetupTyre(11.0, 80.0, 16.0, 3.0, tcETRUNNER, 2.0);

		name= "Mickey Thompson ET Runners 23.5x4.5x16";
