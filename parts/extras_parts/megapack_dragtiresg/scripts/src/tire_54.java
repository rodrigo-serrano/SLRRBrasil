...
public class tire_54 extends Gorgoil_Tyre
{
	public tire_54 ( int id )
	{
		...
		render_types[0]  = parts.extras_parts:0x1ABr;		// for  3.0 inch wide rims //
		render_types[1]  = parts.extras_parts:0x1ABr;		// for  3.5 inch wide rims //
		render_types[2]  = parts.extras_parts:0x1ACr;		// for  4.0 inch wide rims //
		render_types[3]  = parts.extras_parts:0x1ACr;		// for  4.5 inch wide rims //
		render_types[4]  = parts.extras_parts:0x1ADr;		// for  5.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1ABr;		// this rendertype as default //
