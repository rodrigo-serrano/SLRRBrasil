...
public class tire_36 extends Gorgoil_Tyre
{
	public tire_36 ( int id )
	{
		tyre_size_label = "235/60 R15";
		...
		render_types[12] = parts.extras_parts:0x199r;		// for 9.0 inch wide rims //
		render_types[13] = parts.extras_parts:0x199r;		// for 9.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x199r;		// this rendertype as default //

		SetupTyre(235.0, 60.0, 15.0, 9.0, tcDOTDRAG, 2.0);

		name= "Mickey Thompson Dot Drag Radial 235/60R15";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(235.0, 60.0, 15.0, rim.rim_width, tcDOTDRAG);
