...
public class tire_03 extends Gorgoil_Tyre
{
	public tire_03 ( int id )
	{
		...
		render_types[24] = parts.extras_parts:0x178r;		// for 15.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x178r;		// this rendertype as default //
