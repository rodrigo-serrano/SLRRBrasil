...
public class tire_19 extends Gorgoil_Tyre
{
	public tire_19 ( int id )
	{
		tyre_size_label = "115/80 R15";
		
		render_types = new int[30];
		render_types[0]  = parts.extras_parts:0x188r;		// for  3.0 inch wide rims //
		render_types[1]  = parts.extras_parts:0x188r;		// for  3.5 inch wide rims //
		render_types[2]  = parts.extras_parts:0x189r;		// for  4.0 inch wide rims //
		render_types[3]  = parts.extras_parts:0x189r;		// for  4.5 inch wide rims //
		render_types[4]  = parts.extras_parts:0x18Ar;		// for  5.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x188r;		// this rendertype as default //

		SetupTyre(115.0, 80.0, 15.0, 3.0, tcETRUNNER, 2.0);

		name= "Mickey Thompson ET Runner 22.5x4.5x15";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(115.0, 80.0, 15.0, rim.rim_width, tcETRUNNER);
