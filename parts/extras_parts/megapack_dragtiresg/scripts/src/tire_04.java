...
public class tire_04 extends Gorgoil_Tyre
{
	public tire_04 ( int id )
	{
		...
		render_types[24] = parts.extras_parts:0x179r;		// for 15.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x179r;		// this rendertype as default //
