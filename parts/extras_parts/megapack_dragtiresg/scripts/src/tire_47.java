...
public class tire_47 extends Gorgoil_Tyre
{
	public tire_47 ( int id )
	{
		...
		render_types[12] = parts.extras_parts:0x1A4r;		// for 9.0 inch wide rims //
		render_types[13] = parts.extras_parts:0x1A4r;		// for 9.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1A4r;		// this rendertype as default //

		SetupTyre(235.0, 60.0, 15.0, 9.0, tcDOTDRAG, 2.0);

		name= "GoodYear Dot Drag Radial 235/60R15";
