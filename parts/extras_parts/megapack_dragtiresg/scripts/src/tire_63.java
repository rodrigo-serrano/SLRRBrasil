...
public class tire_63 extends Gorgoil_Tyre
{
	public tire_63 ( int id )
	{
		...
		render_types[24] = parts.extras_parts:0x1B4r;		// for 15.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1B4r;		// this rendertype as default //

		SetupTyre(380.0, 45.0, 15.0, 15.0, tcSLICK, 2.0);

		name= "Hoosier 28x15x15 slick";
