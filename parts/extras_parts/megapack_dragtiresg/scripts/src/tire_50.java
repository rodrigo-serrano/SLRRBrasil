...
public class tire_50 extends Gorgoil_Tyre
{
	public tire_50 ( int id )
	{
		...
		render_types[14] = parts.extras_parts:0x1A7r;		// for 10.0 inch wide rims //
		render_types[15] = parts.extras_parts:0x1A7r;		// for 10.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1A7r;		// this rendertype as default //

		SetupTyre(255.0, 50.0, 16.0, 10.0, tcDOTDRAG, 2.0);

		name= "GoodYear Dot Drag Radial 255/50R16";
