...
public class tire_65 extends Gorgoil_Tyre
{
	public tire_65( int id )
	{
		...
		render_types[26] = parts.extras_parts:0x1B6r;		// for 16.0 inch wide rims //
		render_types[27] = 0;		// for 16.5 inch wide rims //
		render_types[28] = 0;		// for 17.0 inch wide rims //
		render_types[29] = parts.extras_parts:0x1B6r;		// this rendertype as default //

		SetupTyre(405.0, 40.0, 15.0, 16.0, tcSLICK, 2.0);

		name= "Hoosier 28x16x15";
