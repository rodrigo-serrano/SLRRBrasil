...
public class tire_48 extends Gorgoil_Tyre
{
	public tire_48 ( int id )
	{
		...
		render_types[14] = parts.extras_parts:0x1A5r;		// for 10.0 inch wide rims //
		render_types[15] = parts.extras_parts:0x1A5r;		// for 10.5 inch wide rims //
		render_types[16] = parts.extras_parts:0x1A5r;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1A5r;		// this rendertype as default //

		SetupTyre(275.0, 50.0, 15.0, 10.0, tcDOTDRAG, 2.0);

		name= "GoodYear Dot Drag Radial 275/50R15";
