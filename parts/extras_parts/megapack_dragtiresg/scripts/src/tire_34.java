...
public class tire_34 extends Gorgoil_Tyre
{
	public tire_34 ( int id )
	{
		tyre_size_label = "405/60 R15";
		...
		render_types[26] = parts.extras_parts:0x197r;		// for 16.0 inch wide rims //
		render_types[27] = 0;		// for 16.5 inch wide rims //
		render_types[28] = 0;		// for 17.0 inch wide rims //
		render_types[29] = parts.extras_parts:0x197r;		// this rendertype as default //

		SetupTyre(405.0, 60.0, 15.0, 16.0, tcSLICK, 2.0);

		name= "Mickey Thompson 34x16x15 slick";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(405.0, 60.0, 15.0, rim.rim_width, tcSLICK);
