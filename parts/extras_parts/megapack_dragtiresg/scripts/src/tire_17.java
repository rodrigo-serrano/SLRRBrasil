...
public class tire_17 extends Gorgoil_Tyre
{
	public tire_17 ( int id )
	{
		tyre_size_label = "315/60 R15";
		...
		render_types[14] = parts.extras_parts:0x186r;		// for 10.0 inch wide rims //
		render_types[15] = parts.extras_parts:0x186r;		// for 10.5 inch wide rims //
		render_types[16] = parts.extras_parts:0x253r;		// for 11.0 inch wide rims //
		render_types[17] = parts.extras_parts:0x253r;		// for 11.5 inch wide rims //
		render_types[18] = parts.extras_parts:0x256r;		// for 12.0 inch wide rims //
		render_types[19] = parts.extras_parts:0x256r;		// for 12.5 inch wide rims //
		render_types[20] = parts.extras_parts:0x187r;		// for 13.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x187r;		// this rendertype as default //

		SetupTyre(315.0, 60.0, 15.0, 10.0, tcRADIAL, 2.0);

		name= "Mickey Thompson Radial 315/60R15";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			if (render_types[render_type_index])
				...
				setRenderType(render_types[26]);
			SetupTyre(315.0, 60.0, 15.0, rim.rim_width, tcRADIAL);
