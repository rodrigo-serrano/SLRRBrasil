...
public class tire_01 extends Gorgoil_Tyre
{
	public tire_01 ( int id )
	{
		...
		render_types[14] = parts.extras_parts:0x176r;		// for 10.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x176r;		// this rendertype as default //

		SetupTyre(255.0, 65.0, 15.0, 10.0, tcSLICK, 2.0);

		name= "Hoosier 28x10x15 slick";
		name_prefix = "Hoosier";
