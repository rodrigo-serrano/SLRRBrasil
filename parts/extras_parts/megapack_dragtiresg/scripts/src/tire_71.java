...
public class tire_71 extends Gorgoil_Tyre
{
	public tire_71 ( int id )
	{
		...
		render_types[14] = parts.extras_parts:0x1BCr;		// for 10.0 inch wide rims //
		render_types[15] = parts.extras_parts:0x1BCr;		// for 10.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1BCr;		// this rendertype as default //

		SetupTyre(255.0, 50.0, 16.0, 10.0, tcDOTDRAG, 2.0);

		name= "Hoosier Dot Drag Radial 255/50R16";
