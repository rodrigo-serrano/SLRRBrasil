...
public class tire_30 extends Gorgoil_Tyre
{
	public tire_30 ( int id )
	{
		tyre_size_label = "330/50 R15";
		...
		render_types[19] = parts.extras_parts:0x193r;		// for 12.5 inch wide rims //
		render_types[20] = parts.extras_parts:0x193r;		// for 13.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x193r;		// this rendertype as default //

		SetupTyre(330.0, 50.0, 15.0, 13.0, tcSLICK, 2.0);

		name= "Mickey Thompson 28x13x15 slick";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(330.0, 50.0, 15.0, rim.rim_width, tcSLICK);
