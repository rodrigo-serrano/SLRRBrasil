...
public class tire_43 extends Gorgoil_Tyre
{
	public tire_43 ( int id )
	{
		...
		render_types[24] = parts.extras_parts:0x1A0r;		// for 15.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x1A0r;		// this rendertype as default //

		SetupTyre(330.0, 65.0, 15.0, 15.0, tcSLICK, 2.0);

		name= "GoodYear 34x15x15 slick";
