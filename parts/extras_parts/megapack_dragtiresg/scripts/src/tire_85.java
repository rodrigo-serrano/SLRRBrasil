...
public class tire_85 extends Gorgoil_Tyre
{
	public tire_85 ( int id )
	{
		...
		render_types[16] = parts.extras_parts:0x259r;		// for 11.0 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x259r;		// this rendertype as default //

		SetupTyre(280.0, 60.0, 15.0, 11.0, tcSLICK, 2.0);

		name= "Hoosier 28x11x15 slick";
