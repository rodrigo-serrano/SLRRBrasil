...
public class tire_38 extends Gorgoil_Tyre
{
	public tire_38 ( int id )
	{
		tyre_size_label = "225/50 R16";
		...
		render_types[10] = parts.extras_parts:0x19Br; 		// for 8.0 inch wide rims //
		render_types[11] = parts.extras_parts:0x19Br;		// for 8.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x19Br;		// this rendertype as default //

		SetupTyre(225.0, 50.0, 16.0, 8.0, tcDOTDRAG, 2.0);

		name= "Mickey Thompson Dot Drag Radial 225/50R16";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(225.0, 50.0, 16.0, rim.rim_width, tcDOTDRAG);
