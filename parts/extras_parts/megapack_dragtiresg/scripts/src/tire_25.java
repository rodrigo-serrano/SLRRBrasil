...
public class tire_25 extends Gorgoil_Tyre
{
	public tire_25 ( int id )
	{
		...
		render_types[0]  = parts.extras_parts:0x18Er;		// for  3.0 inch wide rims //
		render_types[1]  = parts.extras_parts:0x18Er;		// for  3.5 inch wide rims //
		render_types[2]  = parts.extras_parts:0x18Fr;		// for  4.0 inch wide rims //
		render_types[3]  = parts.extras_parts:0x18Fr;		// for  4.5 inch wide rims //
		render_types[4]  = parts.extras_parts:0x190r;		// for  5.0 inch wide rims //
		render_types[5]  = parts.extras_parts:0x190r;		// for  5.5 inch wide rims //
		render_types[6]  = parts.extras_parts:0x191r;		// for  6.0 inch wide rims //
