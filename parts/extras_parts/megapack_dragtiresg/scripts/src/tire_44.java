...
public class tire_44 extends Gorgoil_Tyre
{
	public tire_44( int id )
	{
		...
		render_types[26] = parts.extras_parts:0x1A1r;		// for 16.0 inch wide rims //
		render_types[27] = 0;		// for 16.5 inch wide rims //
		render_types[28] = 0;		// for 17.0 inch wide rims //
		render_types[29] = parts.extras_parts:0x1A1r;		// this rendertype as default //

		SetupTyre(405.0, 40.0, 15.0, 16.0, tcSLICK, 2.0);

		name= "GoodYear 28x16x15";
