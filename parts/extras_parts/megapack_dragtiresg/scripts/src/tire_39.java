...
public class tire_39 extends Gorgoil_Tyre
{
	public tire_39 ( int id )
	{
		tyre_size_label = "255/50 R16";
		...
		render_types[14] = parts.extras_parts:0x19Cr;		// for 10.0 inch wide rims //
		render_types[15] = parts.extras_parts:0x19Cr;		// for 10.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x19Cr;		// this rendertype as default //

		SetupTyre(255.0, 50.0, 16.0, 10.0, tcDOTDRAG, 2.0);

		name= "Mickey Thompson Dot Drag Radial 255/50R16";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(255.0, 50.0, 16.0, rim.rim_width, tcDOTDRAG);
