...
public class tire_11 extends Gorgoil_Tyre
{
	public tire_11 ( int id )
	{
		...
		render_types[14] = parts.extras_parts:0x180r;		// for 10.0 inch wide rims //
		render_types[15] = parts.extras_parts:0x180r;		// for 10.5 inch wide rims //
		...
		render_types[29] = parts.extras_parts:0x180r;		// this rendertype as default //
