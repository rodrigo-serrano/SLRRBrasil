...
public class comando_direito_admissao_original extends DOHC_Camshaft
{
	public comando_direito_admissao_original( int id )
	{
		super( id );
		name = "Comando Admissao Direito Motor V6";
		description = "";
