...
public class cabecote_hyundai_esquerdo extends DOHC_CylinderHead
{
	public cabecote_hyundai_esquerdo( int id )
	{
		super( id );
		name = "Cabecote Esquerdo Motor V6 Hyundai";
		description = "";
		...
		exhaust_efficiency_tuning = 1.02;
