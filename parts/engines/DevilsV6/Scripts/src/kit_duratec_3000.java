...
public class kit_duratec_3000 extends Set
{
	public kit_duratec_3000( int id )
	{
		super( id );
		name = "Motor Ford Duratec 3.0 24v";
		description = "";
	}
	...
	{
		// short block
		inv.insertItem( parts.engines.DevilsV6:0x00000201r ); // bloco
		inv.insertItem( parts.engines.DevilsV6:0x000000FEr ); // virabrequim
		...
		inv.insertItem( parts.engines.DevilsV6:0x00000102r ); // pistoes
		// peripherals
		...
		inv.insertItem( parts.engines.DevilsV6:0x0000A028r ); // cambio
		// heads
