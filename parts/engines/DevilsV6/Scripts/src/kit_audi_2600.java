...
public class kit_audi_2600 extends Set
{
	public kit_audi_2600( int id )
	{
		super( id );
		name = "Motor Audi 2.6 30v";
		description = "";
	}
	...
	{
		// short block
		inv.insertItem( parts.engines.DevilsV6:0x00000301r ); // bloco
		inv.insertItem( parts.engines.DevilsV6:0x0000030Br ); // virabrequim
		...
		inv.insertItem( parts.engines.DevilsV6:0x00000056r ); // pistoes
		// peripherals
