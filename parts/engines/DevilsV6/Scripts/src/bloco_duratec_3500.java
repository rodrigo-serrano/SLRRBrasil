...
public class bloco_duratec_3500 extends Block_DevilsV6
{
	public bloco_duratec_3500( int id )
	{
		super( id );
		name = "Bloco Motor V6 Ford Duratec 3.5";
		description = "";
		...
		crank_center_to_cylinder_top = 255.00;
