...
public class kit_mercedes_3200 extends Set
{
	public kit_mercedes_3200( int id )
	{
		super( id );
		name = "Motor Mercedes 3.2 24v";
		description = "";
	}
	...
	{
		// short block
		inv.insertItem( parts.engines.DevilsV6:0x0000025Ar ); // bloco
		inv.insertItem( parts.engines.DevilsV6:0x0000032Br ); // virabrequim
		...
		inv.insertItem( parts.engines.DevilsV6:0x000008AAr ); // pistoes
		// peripherals
