...
public class cabecote_toyota_esquerdo extends DOHC_CylinderHead
{
	public cabecote_toyota_esquerdo( int id )
	{
		super( id );
		name = "Cabecote Esquerdo Motor V6 Toyota 2GR";
		description = "";
		...
		exhaust_efficiency_tuning = 0.94;
