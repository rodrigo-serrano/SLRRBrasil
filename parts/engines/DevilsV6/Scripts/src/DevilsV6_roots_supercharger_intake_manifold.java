...
public class DevilsV6_roots_supercharger_intake_manifold extends IntakeManifold
{
	public DevilsV6_roots_supercharger_intake_manifold( int id )
	{
		super( id );
		name = "Coletor Admissao Supercharger Roots Motor V6";
		description = "";
	...
	public void updatevariables()
	{
		...
		Part unsafePart;
		if ( (unsafePart = partOnSlot(76)) && unsafePart instanceof AirFuelDeliverySystem)
		{
