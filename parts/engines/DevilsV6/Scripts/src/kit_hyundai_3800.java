...
public class kit_hyundai_3800 extends Set
{
	public kit_hyundai_3800( int id )
	{
		super( id );
		name = "Motor Hyundai 3.8 24v";
		description = "";
	}
	...
	{
		// short block
		inv.insertItem( parts.engines.DevilsV6:0x0000022Ar ); // bloco
		inv.insertItem( parts.engines.DevilsV6:0x00000205r ); // virabrequim
		...
		inv.insertItem( parts.engines.DevilsV6:0x000005AAr ); // pistoes
		// peripherals
