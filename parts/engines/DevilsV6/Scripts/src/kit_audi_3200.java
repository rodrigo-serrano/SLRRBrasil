...
public class kit_audi_3200 extends Set
{
	public kit_audi_3200( int id )
	{
		super( id );
		name = "Motor Audi 3.2 30v";
		description = "";
	}
	...
	{
		// short block
		inv.insertItem( parts.engines.DevilsV6:0x0000003Fr ); // bloco
		inv.insertItem( parts.engines.DevilsV6:0x0000003Er ); // virabrequim
		...
		inv.insertItem( parts.engines.DevilsV6:0x00000101r ); // pistoes
		// peripherals
		...
		inv.insertItem( parts.engines.DevilsV6:0x0000A027r ); // cambio
		// heads
		...
		inv.insertItem( parts.engines.DevilsV6:0x000006BDr ); // tampa valvula esquerda
		inv.insertItem( parts.engines.DevilsV6:0x000006BCr ); // tampa valvula direita
