...
public class cabecote_duratec_esquerdo extends DOHC_CylinderHead
{
	public cabecote_duratec_esquerdo( int id )
	{
		super( id );
		name = "Cabecote Esquerdo Motor V6 Ford Duratec";
		description = "";
		...
		exhaust_efficiency_tuning = 1.05;
