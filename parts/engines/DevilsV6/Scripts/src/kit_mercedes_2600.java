...
public class kit_mercedes_2600 extends Set
{
	public kit_mercedes_2600( int id )
	{
		super( id );
		name = "Motor Mercedes 2.6 24v";
		description = "";
	}
	...
	{
		// short block
		inv.insertItem( parts.engines.DevilsV6:0x0000023Ar ); // bloco
		inv.insertItem( parts.engines.DevilsV6:0x000003FEr ); // virabrequim
		...
		inv.insertItem( parts.engines.DevilsV6:0x000006AAr ); // pistoes
		// peripherals
