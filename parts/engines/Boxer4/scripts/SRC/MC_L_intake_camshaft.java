...
public class MC_L_intake_camshaft extends DOHC_Camshaft
{
	public MC_L_intake_camshaft( int id )
	{
		super( id );
		name = "Comando De Admissao Esquerdo Subaru EJ20";
		description = "";
		...
		static_input_lobe_separation	= 190.0;
