...
public class SuperDuty_Extra_750_intake_manifold extends IntakeManifold
{
	public SuperDuty_Extra_750_intake_manifold( int id )
	{
		super( id );
		name = "Coletor De Admissao HKS Subaru EJ";
		description = "";

		value = 1200;
		brand_new_prestige_value = 60.09;
