...
public class SuperDuty_L_exhaust_camshaft extends DOHC_Camshaft
{
	public SuperDuty_L_exhaust_camshaft( int id )
	{
		super( id );
		name = "Comando De Escapamento Esquerdo Subaru EJ25";
		description = "";
