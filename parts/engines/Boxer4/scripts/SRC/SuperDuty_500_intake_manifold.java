...
public class SuperDuty_500_intake_manifold extends IntakeManifold
{
	public SuperDuty_500_intake_manifold( int id )
	{
		super( id );
		name = "Coletor De Admissao Subaru EJ";
		description = "";

		value = 300;
		brand_new_prestige_value = 20.09;
		setMaxWear(kmToMaxWear(630000.0));

		fuel_rail_slot_ID=11;
	...
	public void updatevariables()
	{
		...
		Part unsafePart;
		if ( (unsafePart = partOnSlot(11)) && unsafePart instanceof AirFuelDeliverySystem)
		{
		...
		if ( (unsafePart = partOnSlot(4)) && unsafePart instanceof NOSInjectorSystem)
		{
