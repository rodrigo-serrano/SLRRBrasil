...
public class block_AP20 extends Block_Inline_OHC
{
	public block_AP20( int id )
	{
		super( id );
		name = "Bloco Volkswagen AP 2.0";
		...
		rpm_idle = 1000.0;
		time_spark_min	= sparkAngleTo4cycleTime(322.0);
		time_spark_inc	= sparkAngleTo4cycleTime(350.0)-time_spark_min;
		time_spark_RPM0	= 1700;
