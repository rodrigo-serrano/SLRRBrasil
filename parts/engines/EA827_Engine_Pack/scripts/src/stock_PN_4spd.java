...
public class stock_PN_4spd extends Transmission
{
	public stock_PN_4spd( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PN 4 Marchas";
		description = "Stock transmission for 1.6L 3+E engines.";
