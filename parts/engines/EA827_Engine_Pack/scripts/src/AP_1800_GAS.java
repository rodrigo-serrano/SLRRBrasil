...
public class AP_1800_GAS extends Set
{
	public AP_1800_GAS( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 1800 Carburado Gasolina";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x00000096r ); // Pistoes
