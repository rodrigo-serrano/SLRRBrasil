...
public class AP_2000_ALC extends Set
{
	public AP_2000_ALC( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 2000 Carburado Alcool";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x000017AAr ); // Pistoes
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x000028AAr ); // Cambio
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x0000F083r ); // Comando
