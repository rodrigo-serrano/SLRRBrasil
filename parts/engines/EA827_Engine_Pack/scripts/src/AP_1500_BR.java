...
public class AP_1500_BR extends Set
{
	public AP_1500_BR( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 1500 Bielinha Gasolina BR";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x0000F070r ); // Pistoes
