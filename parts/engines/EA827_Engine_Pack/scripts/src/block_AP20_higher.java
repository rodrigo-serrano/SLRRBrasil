...
public class block_AP20_higher extends Block_Inline_OHC
{
	public block_AP20_higher( int id )
	{
		super( id );
		name = "Bloco Alto Volkswagen AP 2.0";
		...
		crank_center_to_cylinder_top = 257.0;

		rpm_idle = 1000.0;
		time_spark_min	= sparkAngleTo4cycleTime(332.0);
		time_spark_inc	= sparkAngleTo4cycleTime(367.0)-time_spark_min;
