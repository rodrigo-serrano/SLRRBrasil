...
public class intake_manifold_8v_Mi_crossed_flow extends IntakeManifold
{
	public intake_manifold_8v_Mi_crossed_flow( int id )
	{
		super( id );
		name = "Coletor De Admissao Volkswagen AP 8v Fluxo Cruzado Golf";
		description = "";
