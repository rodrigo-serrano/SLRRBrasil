...
public class AP_2000_FLUXO_BORA extends Set
{
	public AP_2000_FLUXO_BORA( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 2000 Fluxo Cruzado Bora";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x0000AB80r ); // Tampa Cabecote
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x0000F119r ); // Coletor Admissao
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x0000F114r ); // Flauta
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x0000F106r ); // Filtro
