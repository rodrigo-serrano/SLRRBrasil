...
public class stock_PQ_4spd extends Transmission
{
	public stock_PQ_4spd( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PQ 4 Marchas";
		description = "Stock transmission for 1.6L AE engines.";
