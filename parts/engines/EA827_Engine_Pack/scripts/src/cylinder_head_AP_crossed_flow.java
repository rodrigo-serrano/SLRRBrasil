...
public class cylinder_head_AP_crossed_flow extends SOHC_CylinderHead
{
	public cylinder_head_AP_crossed_flow( int id )
	{
		super( id );
		name = "Cabecote Volkswagen AP 2.0 Fluxo Cruzado";
		description = "";
		...
		number_of_intake_valves_per_cylinder = 1.35;
		exhaust_valve_diam = 33.0;
		number_of_exhaust_valves_per_cylinder = 1.25;
