...
public class AP_1500_BR_ALC extends Set
{
	public AP_1500_BR_ALC( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 1500 Bielinha Alcool BR";
		description = "";
	}

	public void build( Inventory inv )
	{
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x0000F050r ); // Bloco
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x000033FFr ); // Pistoes
