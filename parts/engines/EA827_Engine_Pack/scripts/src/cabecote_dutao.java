...
public class cabecote_dutao extends SOHC_CylinderHead
{
	public cabecote_dutao( int id )
	{
		super( id );
		name = "Cabecote Volkswagen AP 2.0 8v Unilateral Passat Alemao";
		description = "";
		...
		number_of_intake_valves_per_cylinder = 1.25;
