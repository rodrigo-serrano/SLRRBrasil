...
public class stock_PB_4spd extends Transmission
{
	public stock_PB_4spd( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PB 4 Marchas";
		description = "Stock transmission for 1.6L engines.";
