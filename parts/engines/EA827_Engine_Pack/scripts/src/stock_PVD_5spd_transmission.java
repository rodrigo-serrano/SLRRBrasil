...
public class stock_PVD_5spd_transmission extends Transmission
{
	public stock_PVD_5spd_transmission( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PVD";
		description = "Stock transmission for carburated 2.0L engines.";
