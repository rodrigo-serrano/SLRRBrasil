...
public class intake_manifold_8v_Mi_crossed_flow_2 extends IntakeManifold
{
	public intake_manifold_8v_Mi_crossed_flow_2( int id )
	{
		super( id );
		name = "Coletor De Admissao Volkswagen AP 8v Fluxo Cruzado Bora";
		description = "";
