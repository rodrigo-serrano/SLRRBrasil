...
public class block_BS_MD270 extends Block_Inline_OHC
{
	public block_BS_MD270( int id )
	{
		super( id );
		name = "Bloco Volkswagen AP Bielinha 1.6 BS/MD-270";
		...
		rpm_idle = 900.0;
		time_spark_min	= sparkAngleTo4cycleTime(317.0);
		time_spark_inc	= sparkAngleTo4cycleTime(350.0)-time_spark_min;
