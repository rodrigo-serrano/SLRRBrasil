...
public class AP_1600_MD_ALC extends Set
{
	public AP_1600_MD_ALC( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 1600 Bielinha Alcool MD-270";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x000019AAr ); // Pistoes
