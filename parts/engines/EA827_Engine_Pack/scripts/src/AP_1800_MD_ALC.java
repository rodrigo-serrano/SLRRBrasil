...
public class AP_1800_MD_ALC extends Set
{
	public AP_1800_MD_ALC( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 1800 Bielinha Alcool MD-280";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x000020AAr ); // Pistoes
