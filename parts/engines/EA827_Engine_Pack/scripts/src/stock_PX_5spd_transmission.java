...
public class stock_PX_5spd_transmission extends Transmission
{
	public stock_PX_5spd_transmission( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PX";
		description = "Stock transmission for BS and MD-270 engines.";
