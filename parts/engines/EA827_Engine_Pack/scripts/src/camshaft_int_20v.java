...
public class camshaft_int_20v extends DOHC_Camshaft
{
	public camshaft_int_20v( int id )
	{
		super( id );
		name = "Comando Original De Admissao Volkswagen AP 20v Turbo";
		description = "";
		...
		static_input_lobe_separation	= 206.0;
