...
public class intake_carburetor extends IntakeManifold
{
	public intake_carburetor( int id )
	{
		super( id );
		name = "Coletor De Admissao Volkswagen AP 8v Carburado";
		description = "Stock carburetor intake for Volkswagen EA-827.";
