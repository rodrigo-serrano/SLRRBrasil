...
public class pistons_BS_alc extends Piston
{
	public pistons_BS_alc( int id )
	{
		super( id );
		name = name = "Pistoes Volkswagen AP 1.6 BS Bielinha Alcool";
		...
		bore = 78.0;
		length_from_wrist_pin_center_to_crown_base = 45.35;
		crown_height = 5.85;
		crown_volume = 70.56;
