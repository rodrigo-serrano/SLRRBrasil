...
public class stock_PL_4spd extends Transmission
{
	public stock_PL_4spd( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PL 4 Marchas";
		description = "Stock transmission for 1.6L diesel engines.";
