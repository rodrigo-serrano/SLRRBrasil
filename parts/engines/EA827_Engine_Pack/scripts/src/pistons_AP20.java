...
public class pistons_AP20 extends Piston
{
	public pistons_AP20( int id )
	{
		super( id );
		name = "Pistoes Volkswagen AP 2.0 Gasolina";
		...
		bore = 82.5;
		length_from_wrist_pin_center_to_crown_base = 28.00;
		crown_height = 19.85;
		crown_volume = 70.56;
