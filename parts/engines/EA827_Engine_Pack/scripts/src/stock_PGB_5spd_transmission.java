...
public class stock_PGB_5spd_transmission extends Transmission
{
	public stock_PGB_5spd_transmission( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PGB";
		description = "Stock gearbox for 1.6L AP engines.";
