...
public class stock_AUB_5spd extends Transmission
{
	public stock_AUB_5spd( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP AUB";
		description = "Stock transmission for Transversal engines.";
