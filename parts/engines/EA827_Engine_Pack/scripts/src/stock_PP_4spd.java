...
public class stock_PP_4spd extends Transmission
{
	public stock_PP_4spd( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PP 4 Marchas";
		description = "Stock transmission for 1.8L MD-280 engines.";
