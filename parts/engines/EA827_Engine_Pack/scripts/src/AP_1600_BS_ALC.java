...
public class AP_1600_BS_ALC extends Set
{
	public AP_1600_BS_ALC( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 1600 Bielinha Alcool BS";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x000018AAr ); // Pistoes
