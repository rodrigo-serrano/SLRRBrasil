...
public class stock_PV_5spd_transmission extends Transmission
{
	public stock_PV_5spd_transmission( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PV";
		description = "Stock transmission for 1.8 engines.";
