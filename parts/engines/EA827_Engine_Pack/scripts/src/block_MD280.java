...
public class block_MD280 extends Block_Inline_OHC
{
	public block_MD280( int id )
	{
		super( id );
		name = "Bloco Volkswagen AP Bielinha 1.8 MD-280";
		...
		time_spark_inc	= sparkAngleTo4cycleTime(353.0)-time_spark_min;
