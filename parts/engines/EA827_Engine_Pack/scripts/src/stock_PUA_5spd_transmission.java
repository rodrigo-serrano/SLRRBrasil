...
public class stock_PUA_5spd_transmission extends Transmission
{
	public stock_PUA_5spd_transmission( int id )
	{
		super( id );
		name = "Cambio Volkswagen AP PUA";
		description = "Stock transmission for 2.0L engines.";
