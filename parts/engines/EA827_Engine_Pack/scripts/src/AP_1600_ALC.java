...
public class AP_1600_ALC extends Set
{
	public AP_1600_ALC( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 1600 Carburado Alcool";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x000015AAr ); // Pistoes
