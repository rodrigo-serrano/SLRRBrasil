...
public class AP_1600_MD extends Set
{
	public AP_1600_MD( int id )
	{
		super( id );
		name = "Motor Volkswagen AP 1600 Bielinha Gasolina MD-270";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.EA827_Engine_Pack:0x0000F072r ); // Pistoes
