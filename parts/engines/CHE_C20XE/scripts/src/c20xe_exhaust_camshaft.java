...
public class c20xe_exhaust_camshaft extends DOHC_Camshaft
{
	public c20xe_exhaust_camshaft( int id )
	{
		super( id );
		name = "C20XE exhaust camshaft";
		description = "";
		...
		static_input_lift_out_open	= 16.5;
