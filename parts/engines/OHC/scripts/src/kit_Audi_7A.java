...
public class kit_Audi_7A extends Set
{
	public kit_Audi_7A( int id )
	{
		super( id );
		name = "Motor OHC 1.6";
		description = "";
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.OHC:0x000000BCr ); // Shimutshibu_RC_T5600R1_transmission
		inv.insertItem( parts.engines.OHC:0x00000042r ); // Shimutshibu_RC_DDSB8C_cylinder_head
		...
		inv.insertItem( parts.engines.OHC:0x0000009Br ); // Shimutshibu_WRC_cylinder_head_cover
