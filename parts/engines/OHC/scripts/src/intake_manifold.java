...
public class intake_manifold extends IntakeManifold
{
	public intake_manifold( int id )
	{
		super( id );
		name = "OHC intake manifold";
		description = "";

		value = tHUF2USD(60.481);
		brand_new_prestige_value = 153.28;
		setMaxWear(kmToMaxWear(4000000.0));
