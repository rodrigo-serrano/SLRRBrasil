...
public class cabecote_tempra16v extends DOHC_CylinderHead
{
	public cabecote_tempra16v( int id )
	{
		super( id );
		name = "Cabecote Fiat Twin Cam 2.0 16v";
		description = "";
		...
		intake_valve_diam = 34.40;
		number_of_intake_valves_per_cylinder = 2.0;
		exhaust_valve_diam = 28.40;
