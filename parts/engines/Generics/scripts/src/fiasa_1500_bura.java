...
public class fiasa_1500_bura extends Set
{
	public fiasa_1500_bura( int id )
	{
		super( id );
		name = "Motor Fiasa 1.5 Carburado Gasolina";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Generics:0x000027AAr ); // Pistoes
