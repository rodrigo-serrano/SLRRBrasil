...
public class fiasa_1300_bura_alc extends Set
{
	public fiasa_1300_bura_alc( int id )
	{
		super( id );
		name = "Motor Fiasa 1.3 Carburado Alcool";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Generics:0x000030AAr ); // Virabrequim
		inv.insertItem( parts.engines.Generics:0x0000004Er ); // Mancal Vira
		inv.insertItem( parts.engines.Generics:0x00000056r ); // Bielas
		inv.insertItem( parts.engines.Generics:0x000026AAr ); // Pistoes
