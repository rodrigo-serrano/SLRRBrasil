...
public class cabecote_lada extends SOHC_CylinderHead
{
	public cabecote_lada( int id )
	{
		super( id );
		name = "Cabecote Lada 1.6 8v";
		description = "";
		...
		intake_valve_diam = 37.00;
		number_of_intake_valves_per_cylinder = 1.0;
		exhaust_valve_diam = 31.50;
