...
public class fiasa_1500_bura_alc extends Set
{
	public fiasa_1500_bura_alc( int id )
	{
		super( id );
		name = "Motor Fiasa 1.5 Carburado Alcool";
		description = "";
	}

	public void build( Inventory inv )
	{
		inv.insertItem( parts.engines.Generics:0x000021AAr ); // Bloco
		inv.insertItem( parts.engines.Generics:0x000031AAr ); // Virabrequim
		inv.insertItem( parts.engines.Generics:0x0000004Er ); // Mancal Vira
		inv.insertItem( parts.engines.Generics:0x00000056r ); // Bielas
		inv.insertItem( parts.engines.Generics:0x000028AAr ); // Pistoes
