...
public class cabecote_fiasa extends SOHC_CylinderHead
{
	public cabecote_fiasa( int id )
	{
		super( id );
		name = "Cabecote Fiasa 8v";
		description = "";
		...
		intake_efficiency_tuning = 2.25;
		exhaust_efficiency_tuning = 2.00;

		intake_valve_diam = 34.0;
