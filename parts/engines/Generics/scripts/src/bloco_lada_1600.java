...
public class bloco_lada_1600 extends Block_Inline_OHC
{
	public bloco_lada_1600( int id )
	{
		super( id );
		name = "Bloco Lada 1.6 8v";
		description = "";
		...
		cylinder_length_from_top = 156.00;
		crank_center_to_cylinder_top = 205.00;
