...
public class fiasa_1300_bura extends Set
{
	public fiasa_1300_bura( int id )
	{
		super( id );
		name = "Motor Fiasa 1.3 Carburado Gasolina";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Generics:0x000025AAr ); // Pistoes
