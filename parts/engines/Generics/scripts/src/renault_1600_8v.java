...
public class renault_1600_8v extends Set
{
	public renault_1600_8v( int id )
	{
		super( id );
		name = "Motor Renault 1.6 8v";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Generics:0x000057BAr ); // Comando
