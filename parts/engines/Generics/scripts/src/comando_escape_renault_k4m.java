...
public class comando_escape_renault_k4m extends DOHC_Camshaft
{
	public comando_escape_renault_k4m( int id )
	{
		super( id );
		name = "Comando de Escape Renault 1.6 16v K4M";
		description = "";
		...
		static_input_time_out_duration	= 255.0;
