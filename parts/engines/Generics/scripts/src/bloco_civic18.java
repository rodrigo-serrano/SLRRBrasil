...
public class bloco_civic18 extends Block_Inline_OHC
{
	public bloco_civic18( int id )
	{
		super( id );
		name = "Bloco Honda 1.8 16v R18";
		description = "";
