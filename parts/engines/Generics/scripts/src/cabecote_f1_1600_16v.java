...
public class cabecote_f1_1600_16v extends DOHC_CylinderHead
{
	public cabecote_f1_1600_16v( int id )
	{
		super( id );
		name = "Cabecote Gm Familia 1 1.6 16v";
		description = "";
		...
		intake_efficiency_tuning = 1.80;
		exhaust_efficiency_tuning = 1.80;

		intake_valve_diam = 31.00;
		number_of_intake_valves_per_cylinder = 2.0;
		exhaust_valve_diam = 27.50;
