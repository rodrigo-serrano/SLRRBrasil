...
public class bloco_duratec_2000 extends Block_Inline_OHC
{
	public bloco_duratec_2000( int id )
	{
		super( id );
		name = "Bloco Ford Duratec 2.0 e 2.3 16v";
		description = "";
		...
		crank_center_to_cylinder_top = 246.80;
