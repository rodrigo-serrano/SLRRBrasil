...
public class coletor_adm_tempra8v_turbo extends IntakeManifold
{
	public coletor_adm_tempra8v_turbo( int id )
	{
		super( id );
		name = "Coletor De Admissao Fiat Twin Cam 2.0 8v Turbo";
		description = "";
