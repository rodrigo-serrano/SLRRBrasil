...
public class cabecote_renault_f4r extends DOHC_CylinderHead
{
	public cabecote_renault_f4r( int id )
	{
		super( id );
		name = "Cabecote Renault 2.0 16v F4R";
		description = "";
		...
		intake_valve_diam = 33.40;
		number_of_intake_valves_per_cylinder = 2.0;
		exhaust_valve_diam = 29.00;
