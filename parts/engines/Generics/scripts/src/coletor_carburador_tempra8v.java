...
public class coletor_carburador_tempra8v extends IntakeManifold
{
	public coletor_carburador_tempra8v( int id )
	{
		super( id );
		name = "Coletor De Admissao Fiat Twin Cam 2.0 8v Carburado";
		description = "";
