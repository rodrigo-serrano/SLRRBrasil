...
public class coletor_adm_tempra8v extends IntakeManifold
{
	public coletor_adm_tempra8v( int id )
	{
		super( id );
		name = "Coletor De Admissao Fiat Twin Cam 2.0 8v MPFI";
		description = "";
