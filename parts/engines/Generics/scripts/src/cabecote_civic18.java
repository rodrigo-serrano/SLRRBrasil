...
public class cabecote_civic18 extends DOHC_CylinderHead
{
	public cabecote_civic18( int id )
	{
		super( id );
		name = "Cabecote Honda 1.8 16v R18";
		description = "";
		...
		intake_valve_diam = 32.00;
		number_of_intake_valves_per_cylinder = 2.0;
		exhaust_valve_diam = 26.00;
