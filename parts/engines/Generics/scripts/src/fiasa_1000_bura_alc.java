...
public class fiasa_1000_bura_alc extends Set
{
	public fiasa_1000_bura_alc( int id )
	{
		super( id );
		name = "Motor Fiasa 1.0 Carburado Alcool";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Generics:0x000022AAr ); // Pistoes
