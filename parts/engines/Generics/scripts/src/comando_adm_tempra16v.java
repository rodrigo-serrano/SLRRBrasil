...
public class comando_adm_tempra16v extends DOHC_Camshaft
{
	public comando_adm_tempra16v( int id )
	{
		super( id );
		name = "Comando de Admissao Fiat Twin Cam 2.0 16v";
		description = "";
		...
		static_input_lift_in_open	= 11.85;
