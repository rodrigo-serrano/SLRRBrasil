...
public class comando_escape_renault_re3 extends DOHC_Camshaft
{
	public comando_escape_renault_re3( int id )
	{
		super( id );
		name = "Comando de Escape Carlini RE3 Renault 16v";
		description = "";
		...
		static_input_lift_out_open	= 14.5;
