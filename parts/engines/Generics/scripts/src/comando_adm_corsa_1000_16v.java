...
public class comando_adm_corsa_1000_16v extends DOHC_Camshaft
{
	public comando_adm_corsa_1000_16v( int id )
	{
		super( id );
		name = "Comando de Admissao Corsa 1.0 16v";
		description = "";
		...
		static_input_lift_in_open	= 11.5;
