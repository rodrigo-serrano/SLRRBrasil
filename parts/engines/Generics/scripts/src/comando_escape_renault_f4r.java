...
public class comando_escape_renault_f4r extends DOHC_Camshaft
{
	public comando_escape_renault_f4r( int id )
	{
		super( id );
		name = "Comando de Escape Renault 2.0 16v F4R";
		description = "";
		...
		static_input_lift_out_open	= 11.0;
