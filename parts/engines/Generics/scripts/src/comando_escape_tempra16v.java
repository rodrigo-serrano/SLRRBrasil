...
public class comando_escape_tempra16v extends DOHC_Camshaft
{
	public comando_escape_tempra16v( int id )
	{
		super( id );
		name = "Comando de Escape Fiat Twin Cam 2.0 16v";
		description = "";
		...
		static_input_lift_out_open	= 11.85;
