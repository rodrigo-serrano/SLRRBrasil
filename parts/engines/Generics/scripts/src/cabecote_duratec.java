...
public class cabecote_duratec extends DOHC_CylinderHead
{
	public cabecote_duratec( int id )
	{
		super( id );
		name = "Cabecote Ford Duratec 16v";
		description = "";
		...
		intake_efficiency_tuning = 1.22;
		exhaust_efficiency_tuning = 1.15;

		intake_valve_diam = 35.00;
		number_of_intake_valves_per_cylinder = 2.0;
		exhaust_valve_diam = 30.00;
