...
public class duratec_2000 extends Set
{
	public duratec_2000( int id )
	{
		super( id );
		name = "Motor Ford Duratec 2.0 16v";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Generics:0x000010BAr ); // Pistoes
