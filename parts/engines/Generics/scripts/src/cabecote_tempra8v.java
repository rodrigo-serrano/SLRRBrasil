...
public class cabecote_tempra8v extends DOHC_CylinderHead
{
	public cabecote_tempra8v( int id )
	{
		super( id );
		name = "Cabecote Fiat Twin Cam 2.0 8v";
		description = "";
		...
		intake_efficiency_tuning = 1.30;
		exhaust_efficiency_tuning = 1.28;

		intake_valve_diam = 43.50;
		number_of_intake_valves_per_cylinder = 1.0;
		exhaust_valve_diam = 36.10;
