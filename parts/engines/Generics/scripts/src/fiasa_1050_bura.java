...
public class fiasa_1050_bura extends Set
{
	public fiasa_1050_bura( int id )
	{
		super( id );
		name = "Motor Fiasa 1.05 Carburado Gasolina";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Generics:0x000023AAr ); // Pistoes
