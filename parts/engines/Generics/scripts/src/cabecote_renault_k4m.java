...
public class cabecote_renault_k4m extends DOHC_CylinderHead
{
	public cabecote_renault_k4m( int id )
	{
		super( id );
		name = "Cabecote Renault 2.0 16v K4M";
		description = "";
		...
		intake_valve_diam = 32.70;
		number_of_intake_valves_per_cylinder = 2.0;
		exhaust_valve_diam = 27.90;
