...
public class comando_escape_civic18 extends DOHC_Camshaft
{
	public comando_escape_civic18( int id )
	{
		super( id );
		name = "Comando de Escape Honda 1.8 16v R18";
		description = "";
		...
		static_input_lift_out_open	= 13.95;
