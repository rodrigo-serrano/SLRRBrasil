...
public class comando_endura_kent extends OHV_Camshaft
{
	public comando_endura_kent( int id )
	{
		super( id );
		name = "Comando Kent Cams Importado Ford Endura";
		description = "";
		...
		static_input_time_out_duration	= 295.0;
