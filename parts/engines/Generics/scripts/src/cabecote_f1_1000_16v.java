...
public class cabecote_f1_1000_16v extends DOHC_CylinderHead
{
	public cabecote_f1_1000_16v( int id )
	{
		super( id );
		name = "Cabecote Gm Familia 1 1.0 16v";
		description = "";
		...
		intake_valve_diam = 24.89;
		number_of_intake_valves_per_cylinder = 2.0;
		exhaust_valve_diam = 20.00;
