...
public class duratec_2500 extends Set
{
	public duratec_2500( int id )
	{
		super( id );
		name = "Motor Ford Duratec 2.5 16v";
		description = "";
	}

	public void build( Inventory inv )
	{
		inv.insertItem( parts.engines.Generics:0x000005BAr ); // Bloco
		inv.insertItem( parts.engines.Generics:0x000008BAr ); // Virabrequim
		inv.insertItem( parts.engines.Generics:0x0000004Er ); // Mancal Vira
		inv.insertItem( parts.engines.Generics:0x000013BAr ); // Bielas
		inv.insertItem( parts.engines.Generics:0x000012BAr ); // Pistoes
		inv.insertItem( parts.engines.Generics:0x0000000Ar ); // Volante
		inv.insertItem( parts.engines.Generics:0x00000043r ); // Embreagem
		inv.insertItem( parts.engines.Generics:0x000016BAr ); // Cambio
