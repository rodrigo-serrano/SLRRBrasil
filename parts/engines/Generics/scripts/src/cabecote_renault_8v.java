...
public class cabecote_renault_8v extends SOHC_CylinderHead
{
	public cabecote_renault_8v( int id )
	{
		super( id );
		name = "Cabecote Renault 8v";
		description = "";
		...
		exhaust_efficiency_tuning = 0.80;

		intake_valve_diam = 37.6;
		number_of_intake_valves_per_cylinder = 1.0;
		exhaust_valve_diam = 33.6;
