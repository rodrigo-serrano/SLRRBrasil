...
public class cabecote_marea_1800 extends DOHC_CylinderHead
{
	public cabecote_marea_1800( int id )
	{
		super( id );
		name = "Cabecote Fiat Marea 1.8 16v";
		description = "";
		...
		intake_valve_diam = 33.60;
		number_of_intake_valves_per_cylinder = 2.0;
		exhaust_valve_diam = 28.10;
