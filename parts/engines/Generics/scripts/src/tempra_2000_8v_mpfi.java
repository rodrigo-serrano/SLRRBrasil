...
public class tempra_2000_8v_mpfi extends Set
{
	public tempra_2000_8v_mpfi( int id )
	{
		super( id );
		name = "Motor Fiat Tempra 2.0 8v Injetado";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Generics:0x000093BAr ); // Cambio
		...
		inv.insertItem( parts.engines.Generics:0x0000E741r ); // Coletor Admissao
