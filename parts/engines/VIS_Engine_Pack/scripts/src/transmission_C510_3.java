...
public class transmission_C510_3 extends Transmission
{
	public transmission_C510_3( int id )
	{
		super( id );
		name = "Cambio Fiat C510 Marea 2.4";
		description = "Stock transmission for Fiat Marea 2.4 20v";
