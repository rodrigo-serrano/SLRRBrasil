...
public class transmission_C510_2 extends Transmission
{
	public transmission_C510_2( int id )
	{
		super( id );
		name = "Cambio Fiat C510 Brava HGT";
		description = "Stock transmission for Fiat Brava HGT 1.8 16v.";
