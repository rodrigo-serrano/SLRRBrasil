...
public class transmission_C510_5 extends Transmission
{
	public transmission_C510_5( int id )
	{
		super( id );
		name = "Cambio Fiat C510 Stilo Abarth";
		description = "Stock transmission for Fiat Stilo Abarth";
