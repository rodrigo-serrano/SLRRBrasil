...
public class block_18_16v extends Block_Inline_OHC
{
	public block_18_16v( int id )
	{
		super( id );
		name = "Bloco Fiat V.I.S. 1.8 16v";
		description = "";
		...
		time_spark_inc	= sparkAngleTo4cycleTime(386.0)-time_spark_min;
