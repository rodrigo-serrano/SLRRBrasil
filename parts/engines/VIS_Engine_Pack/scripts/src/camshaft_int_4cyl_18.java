...
public class camshaft_int_4cyl_18 extends DOHC_Camshaft
{
	public camshaft_int_4cyl_18( int id )
	{
		super( id );
		name = "Comando De Admissao Fiat V.I.S. 1.8 16v";
		description = "";
		...
		static_input_lobe_separation	= 209.0;
		static_input_lift_in_open	= 12.7;
