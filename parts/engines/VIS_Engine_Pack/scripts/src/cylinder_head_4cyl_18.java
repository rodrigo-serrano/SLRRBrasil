...
public class cylinder_head_4cyl_18 extends DOHC_CylinderHead
{
	public cylinder_head_4cyl_18( int id )
	{
		super( id );
		name = "Cabecote Fiat V.I.S. 1.8 16v";
		description = "";
