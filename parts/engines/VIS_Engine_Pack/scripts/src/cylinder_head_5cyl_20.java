...
public class cylinder_head_5cyl_20 extends DOHC_CylinderHead
{
	public cylinder_head_5cyl_20( int id )
	{
		super( id );
		name = "Cabecote Fiat V.I.S. 2.0 20v";
		description = "";
