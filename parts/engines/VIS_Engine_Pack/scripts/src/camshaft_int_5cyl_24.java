...
public class camshaft_int_5cyl_24 extends DOHC_Camshaft
{
	public camshaft_int_5cyl_24( int id )
	{
		super( id );
		name = "Comando De Admissao Fiat V.I.S. 2.4 20v";
		description = "";
		...
		static_input_lobe_separation	= 210.5;
