...
public class block_20_20v extends Block_Inline_OHC
{
	public block_20_20v( int id )
	{
		super( id );
		name = "Bloco Fiat V.I.S. 2.0 20v";
		description = "";
		...
		rpm_idle = 1000.0;
		time_spark_min	= sparkAngleTo4cycleTime(333.0);
		time_spark_inc	= sparkAngleTo4cycleTime(388.0)-time_spark_min;
