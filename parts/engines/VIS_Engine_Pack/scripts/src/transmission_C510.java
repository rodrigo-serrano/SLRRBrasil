...
public class transmission_C510 extends Transmission
{
	public transmission_C510( int id )
	{
		super( id );
		name = "Cambio Fiat C510 Marea 1.8 / 2.0";
		description = "Stock transmission for Fiat Marea 1.8 16v and 2.0 20v.";
