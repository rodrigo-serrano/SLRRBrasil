...
public class opala_4400 extends Set
{
	public opala_4400( int id )
	{
		super( id );
		name = "Motor Opala 4.4";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.chevrolet_250:0x0000121Ar ); // Pistoes
		...
		inv.insertItem( parts.engines.chevrolet_250:0x00008B11r ); // Coletor Escape
