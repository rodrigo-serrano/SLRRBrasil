...
public class h34_supercharles extends FuelInjectorSystem
{
	public h34_supercharles( int id )
	{
		super( id );
		name = "Carburador H34 Para Supercharger Chevrolet 250";
		description = "";
