...
public class coletor_adm_weber_dcoe extends IntakeManifold
{
	public coletor_adm_weber_dcoe( int id )
	{
		super( id );
		name = "Coletor De Admissao Tripla Weber DCOE Chevrolet 250";
		description = "";
