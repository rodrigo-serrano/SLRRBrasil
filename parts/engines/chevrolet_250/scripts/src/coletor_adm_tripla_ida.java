...
public class coletor_adm_tripla_ida extends IntakeManifold
{
	public coletor_adm_tripla_ida( int id )
	{
		super( id );
		name = "Coletor De Admissao Dupla Weber IDA do Porsche Chevrolet 250";
		description = "";
