...
public class comando_crower292 extends OHV_Camshaft
{
	public comando_crower292( int id )
	{
		super( id );
		name = "Comando Crower 292x298 107° Chevrolet 250";
		description = "";
		...
		static_input_time_in_duration	= 280.0;
