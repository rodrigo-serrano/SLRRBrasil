...
public class kit_vr_6_32 extends Set
{
	public kit_vr_6_32( int id )
	{
		super( id );
		name = "Kit Motor VR6 3.2";
		description = "";
	}

	public void build( Inventory inv )
	{
	        inv.insertItem( parts.engines.vr_6:0x00000052r ); // block
                ...
                inv.insertItem( parts.engines.vr_6:0x00000044r ); // crankshaft
                inv.insertItem( parts.engines.vr_6:0x00000056r ); // connecting_rods
                inv.insertItem( parts.engines.vr_6:0x0000000Ar ); // flywheel
		inv.insertItem( parts.engines.vr_6:0x00000043r ); // clutch
                ...
                inv.insertItem( parts.engines.vr_6:0x00000057r ); // pistons
		...
		inv.insertItem( parts.engines.vr_6:0x00000085r ); // transmission
                inv.insertItem( parts.engines.vr_6:0x0000a084r ); // head_gasket
		inv.insertItem( parts.engines.vr_6:0x00000042r ); // cylinder_head
                inv.insertItem( parts.engines.vr_6:0x0000a184r ); // block_nut
                inv.insertItem( parts.engines.vr_6:0x0000c884r ); // spark
                inv.insertItem( parts.engines.vr_6:0x00000099r ); // exhaust_camshaft
                inv.insertItem( parts.engines.vr_6:0x0000a984r ); // exhaust_camshaft_weel
		inv.insertItem( parts.engines.vr_6:0x0000009Ar ); // intake_camshaft
		...
		inv.insertItem( parts.engines.vr_6:0x0000008Fr ); // valve_cover
                ...
                inv.insertItem( parts.engines.vr_6:0x00000098r ); // exhaust_header
                inv.insertItem( parts.engines.vr_6:0x0000e384r ); // exhaust_header_nut
		inv.insertItem( parts.engines.vr_6:0x00000097r ); // intake_manifold
		inv.insertItem( parts.engines.vr_6:0x0000b884r ); // intake_manifold_underpart
                ...
                inv.insertItem( parts.engines.vr_6:0x000000E2r ); // fuel_rail
