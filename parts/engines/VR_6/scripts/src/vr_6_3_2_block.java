...
public class vr_6_3_2_block extends Block_Inline_OHC
{
	public vr_6_3_2_block( int id )
	{
		super( id );
		name = "Bloco VW VR6 3.2";
		description = "";

		brand_new_prestige_value = 82.03;
		value = tHUF2USD(124);
		...
		rpm_idle = 950.0;
		time_spark_min	= sparkAngleTo4cycleTime(308.0);
