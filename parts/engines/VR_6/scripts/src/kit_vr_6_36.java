...
public class kit_vr_6_36 extends Set
{
	public kit_vr_6_36( int id )
	{
		super( id );
		name = "Kit Motor VR6 3.6";
		description = "";
	}

	public void build( Inventory inv )
	{
	        inv.insertItem( parts.engines.vr_6:0x0000007Fr ); // block
                ...
                inv.insertItem( parts.engines.vr_6:0x00000080r ); // crankshaft
                inv.insertItem( parts.engines.vr_6:0x00000093r ); // connecting_rods
		...
		inv.insertItem( parts.engines.vr_6:0x00000043r ); // clutch
                ...
                inv.insertItem( parts.engines.vr_6:0x00000096r ); // pistons
		...
		inv.insertItem( parts.engines.vr_6:0x00000082r ); // cylinder_head
                inv.insertItem( parts.engines.vr_6:0x0000a184r ); // block_nut
                inv.insertItem( parts.engines.vr_6:0x0000c884r ); // spark
                inv.insertItem( parts.engines.vr_6:0x000000E1r ); // exhaust_camshaft
                inv.insertItem( parts.engines.vr_6:0x0000a984r ); // exhaust_camshaft_weel
		inv.insertItem( parts.engines.vr_6:0x000000E0r ); // intake_camshaft
		...
		inv.insertItem( parts.engines.vr_6:0x0000008Fr ); // valve_cover
                ...
                inv.insertItem( parts.engines.vr_6:0x0000008Dr ); // exhaust_header
                inv.insertItem( parts.engines.vr_6:0x0000e384r ); // exhaust_header_nut
		inv.insertItem( parts.engines.vr_6:0x00000092r ); // intake_manifold
		inv.insertItem( parts.engines.vr_6:0x0000b884r ); // intake_manifold_underpart
                ...
                inv.insertItem( parts.engines.vr_6:0x000000DFr ); // fuel_rail
