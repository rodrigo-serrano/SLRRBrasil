...
public class vr_6_2_9_intake_camshaft extends DOHC_Camshaft
{
	public vr_6_2_9_intake_camshaft( int id )
	{
		super( id );
		name = "Comando De Admissao VW VR6 2.9";
		description = " ";
		...
		static_input_lobe_separation	= 202.0;
