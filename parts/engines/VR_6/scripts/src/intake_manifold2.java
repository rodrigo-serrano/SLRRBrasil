...
public class intake_manifold2 extends IntakeManifold
{
	public intake_manifold2( int id )
	{
		super( id );
		name = "Coletor De Admissao Racing VW VR6";
		description = "";
	...
	public String isDynoable()
	{
		...
		if (!p)
			return "the intake manifold is missing the throttle.";
                ...
                p = partOnSlot( 32 );
		if (!p)
			return "the intake manifold is missing the intake manifold screw.";
