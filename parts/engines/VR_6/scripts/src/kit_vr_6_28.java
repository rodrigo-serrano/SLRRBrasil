...
public class kit_vr_6_28 extends Set
{
	public kit_vr_6_28( int id )
	{
		super( id );
		name = "Kit Motor VR6 2.8";
		description = "";
	}

	public void build( Inventory inv )
	{
	        inv.insertItem( parts.engines.vr_6:0x00000041r ); // block
                ...
                inv.insertItem( parts.engines.vr_6:0x00000053r ); // crankshaft
                inv.insertItem( parts.engines.vr_6:0x00000055r ); // connecting_rods
		...
		inv.insertItem( parts.engines.vr_6:0x00000043r ); // clutch
                ...
                inv.insertItem( parts.engines.vr_6:0x00000054r ); // pistons
		...
		inv.insertItem( parts.engines.vr_6:0x00000050r ); // cylinder_head
                inv.insertItem( parts.engines.vr_6:0x0000a184r ); // block_nut
                inv.insertItem( parts.engines.vr_6:0x0000c884r ); // spark
                inv.insertItem( parts.engines.vr_6:0x00000059r ); // exhaust_camshaft
                inv.insertItem( parts.engines.vr_6:0x0000a984r ); // exhaust_camshaft_weel
		inv.insertItem( parts.engines.vr_6:0x0000005Ar ); // intake_camshaft
		...
		inv.insertItem( parts.engines.vr_6:0x0000008Fr ); // valve_cover
                ...
                inv.insertItem( parts.engines.vr_6:0x0000004Cr ); // exhaust_header
                inv.insertItem( parts.engines.vr_6:0x0000e384r ); // exhaust_header_nut
		inv.insertItem( parts.engines.vr_6:0x0000004Ar ); // intake_manifold
		inv.insertItem( parts.engines.vr_6:0x0000b884r ); // intake_manifold_underpart
                ...
                inv.insertItem( parts.engines.vr_6:0x0000004Br ); // fuel_rail
