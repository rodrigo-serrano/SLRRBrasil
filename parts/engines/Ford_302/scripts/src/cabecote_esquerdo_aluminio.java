...
public class cabecote_esquerdo_aluminio extends OHV_CylinderHead
{
	public cabecote_esquerdo_aluminio( int id )
	{
		super( id );
		name = "Cabecote Pro Comp Aluminio Ford 302 Esquerdo";
		description = "";
		...
		intake_efficiency_tuning = 1.20;
		exhaust_efficiency_tuning = 1.15;

		intake_valve_diam = 45.50;
		number_of_intake_valves_per_cylinder = 1.0;
		exhaust_valve_diam = 38.00;
