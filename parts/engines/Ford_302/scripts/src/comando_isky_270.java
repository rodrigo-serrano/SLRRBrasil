...
public class comando_isky_270 extends OHV_Camshaft
{
	public comando_isky_270( int id )
	{
		super( id );
		name = "Comando Iskenderian 270x270 108º Ford 302";
		description = "";
		...
		static_input_lift_in_open	= 15.25;
		static_input_lift_in_close	= 0.0;
		static_input_lift_out_open	= 15.25;
