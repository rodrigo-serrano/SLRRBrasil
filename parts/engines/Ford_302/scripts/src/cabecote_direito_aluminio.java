...
public class cabecote_direito_aluminio extends OHV_CylinderHead
{
	public cabecote_direito_aluminio( int id )
	{
		super( id );
		name = "Cabecote Pro Comp Aluminio Ford 302 Direito";
		description = "";
