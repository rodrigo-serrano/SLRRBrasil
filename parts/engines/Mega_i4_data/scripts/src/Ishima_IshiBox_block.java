...
public class Ishima_IshiBox_block extends Block_Inline_OHC
{
	...
	{
		super( id );
		name = "E.Torq 1.6 16v Block";
		description = "Manifatured in 2011, is a new Fiat Engine.";
		...
		cylinder_length_from_top = 121.66;
		crank_center_to_cylinder_top = 239.40;

		rpm_idle = 1000.0;
		time_spark_min	= sparkAngleTo4cycleTime(337.0);
		time_spark_inc	= sparkAngleTo4cycleTime(385.0)-time_spark_min;
		time_spark_RPM0	= 2200;
		time_spark_RPM1	= 6800;
		RPM_limit	= 6400;
