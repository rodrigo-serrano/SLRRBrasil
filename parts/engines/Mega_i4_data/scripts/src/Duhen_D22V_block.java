...
public class Duhen_D22V_block extends Block_Inline_OHC
{
	...
	{
		super( id );
		name = "Ford Zetec Rocam 1.6 block";
		description = "Made to Ford Fiesta Mk5, mk6 and mk7(Brazil) Ford Focus and Ford Ecosport(European Fusion). Manufatured on Brazil in 2000";
		...
		crank_center_to_cylinder_top = 216.50;

		rpm_idle = 850.0;
		time_spark_min	= sparkAngleTo4cycleTime(335.0);
		time_spark_inc	= sparkAngleTo4cycleTime(385.0)-time_spark_min;
		time_spark_RPM0	= 1900;
