...
public class Einvagen_PerPro_GTA_block extends Block_Inline_OHC
{
	...
	{
		super( id );
		name = "Volkswagen 2.0 EA-113 block";
		description = "Made for Volkswagen Gol (G3), Volkswagen Golf, Jetta(Bora) and Polo. This have as base the old AP(Alta Performance), in 1997 equipped Golf Mk4";
		...
		crank_center_to_cylinder_top = 265.10;
