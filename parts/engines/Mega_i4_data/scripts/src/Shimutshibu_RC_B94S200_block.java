...
public class Shimutshibu_RC_B94S200_block extends Block_Inline_OHC
{
	...
	{
		super( id );
		name = "Powertech 2.0 block";
		description = "Manufatured on 80 years, today is ultilized with more tecnology on GM popular cars.";
		...
		crank_center_to_cylinder_top = 245.69;

		rpm_idle = 900.0;
		time_spark_min	= sparkAngleTo4cycleTime(335.0);
		time_spark_inc	= sparkAngleTo4cycleTime(378.0)-time_spark_min;
