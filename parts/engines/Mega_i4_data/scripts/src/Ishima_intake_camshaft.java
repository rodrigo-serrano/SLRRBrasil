...
public class Ishima_intake_camshaft extends DOHC_Camshaft
{
	public Ishima_intake_camshaft( int id )
	{
		super( id );
		name = "E.Torq intake camshaft";
		description = "";
		...
		static_input_lobe_separation	= 200.8;
