...
public class kit_SeriesKhonda_6 extends Set
{
	public kit_SeriesKhonda_6( int id )
	{
		super( id );
		name = "Motor Honda K20 Supercharger Aeriel";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.SeriesKhonda:0x00000057r ); // pistons 2
		...
		inv.insertItem( parts.engines.SeriesKhonda:0x0000DC98r ); // Baiern_GT_III_exhaust_header
		...
		inv.insertItem( parts.engines.SeriesKhonda:0x0000098Dr ); // oil2
