...
public class block_2 extends Block_Inline_OHC
{
	public block_2( int id )
	{
		super( id );
		name = "Bloco Motor Honda K24 Emcamisado";
		description = "";
		...
		cylinder_length_from_top = 177.50;
		crank_center_to_cylinder_top = 231.50+0.635;
	...
	public String isDynoable()
	{
		...
		p = partOnSlot( 111 );
		if (!p)
			return "O Motor esta sem Capa Da Correia.";
