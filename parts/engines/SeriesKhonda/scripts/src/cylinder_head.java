...
public class cylinder_head extends DOHC_CylinderHead
{
	public cylinder_head( int id )
	{
		super( id );
		name = "Cabecote Honda K20";
		description = "";
		...
		intake_efficiency_tuning = 0.95;
		exhaust_efficiency_tuning = 0.95;
