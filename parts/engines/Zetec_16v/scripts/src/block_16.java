...
public class block_16 extends Block_Inline_OHC
{
	...
	{
		super( id );
		name = "Bloco Motor Modificado Zetec 2.1 16v";
		description = "Este bloco foi aberto medidas de pistão para aceitar pistões gm 2.0, passando de 84,8mm para 86mm.";
		...
		crank_center_to_cylinder_top = 242.65;
