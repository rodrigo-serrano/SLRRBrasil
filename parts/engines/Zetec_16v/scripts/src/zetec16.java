...
public class zetec16 extends Set
{
	public zetec16( int id )
	{
		super( id );
		name = "Motor Zetec 1.6 16v";
		description = "";
	}

	public void build( Inventory inv )
	{
		inv.insertItem( parts.engines.Zetec_16v:0x00000052r ); // Bloco
		inv.insertItem( parts.engines.Zetec_16v:0x00000044r ); // Virabrequim
		inv.insertItem( parts.engines.Zetec_16v:0x0000004Er ); // Mancal Vira
		inv.insertItem( parts.engines.Zetec_16v:0x00000093r ); // Bielas
		inv.insertItem( parts.engines.Zetec_16v:0x00000057r ); // Pistoes
