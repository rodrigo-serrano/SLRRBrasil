...
public class zetec21turbo extends Set
{
	public zetec21turbo( int id )
	{
		super( id );
		name = "Motor Zetec 2.1 16v Turbo";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Zetec_16v:0x00000051r ); // Turbina
		inv.insertItem( parts.engines.Zetec_16v:0x00007720r ); // Pressurização
		inv.insertItem( parts.engines.Zetec_16v:0x00000E98r ); // Escape Turbina
	}
}