...
public class pistoes_94_alto extends Piston
{
	public pistoes_94_alto( int id )
	{
		super( id );
		name = "Pistoes Motor Fusca D:94mm A:30mm";
		description = "";
		...
		bore = 94.00;
		length_from_wrist_pin_center_to_crown_base = 30.00;// Piston Compression Height
