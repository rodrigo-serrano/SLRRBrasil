...
public class pistoes_94_medio extends Piston
{
	public pistoes_94_medio( int id )
	{
		super( id );
		name = "Pistoes Motor Fusca D:94mm A:25mm";
		description = "";
		...
		bore = 94.00;
		length_from_wrist_pin_center_to_crown_base = 25.00;// Piston Compression Height
