...
public class fusca_2400_aspro extends Set
{
	public fusca_2400_aspro( int id )
	{
		super( id );
		name = "Motor Fusca 2400 Aspirado";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.boxer_fusca:0x00006800r ); // Escapamento
