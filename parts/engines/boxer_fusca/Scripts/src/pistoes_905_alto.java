...
public class pistoes_905_alto extends Piston
{
	public pistoes_905_alto( int id )
	{
		super( id );
		name = "Pistoes Motor Fusca D:90,5mm A:28mm";
		description = "";
		...
		bore = 90.50;
		length_from_wrist_pin_center_to_crown_base = 28.00;// Piston Compression Height
