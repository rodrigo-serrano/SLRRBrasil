...
public class cabecote_1300_esquerdo extends OHV_CylinderHead
{
	public cabecote_1300_esquerdo( int id )
	{
		super( id );
		name = "Cabecote Direito Motor Fusca 1300";
		description = "";
