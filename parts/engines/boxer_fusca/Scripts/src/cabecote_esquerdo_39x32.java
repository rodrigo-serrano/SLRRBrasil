...
public class cabecote_esquerdo_39x32 extends OHV_CylinderHead
{
	public cabecote_esquerdo_39x32( int id )
	{
		super( id );
		name = "Cabecote Esquerdo Valvulas 39x32 Motor Fusca";
		description = "";
		...
		intake_valve_diam = 39.00;
		number_of_intake_valves_per_cylinder = 1.0;
		exhaust_valve_diam = 32.50;
