...
public class pistoes_captiva extends Piston
{
	public pistoes_captiva( int id )
	{
		super( id );
		name = "Pistoes Captiva 2.4 adaptados Motor Fusca 88mm";
		description = "";
		...
		bore = 88.00;
		length_from_wrist_pin_center_to_crown_base = 22.00;// Piston Compression Height
