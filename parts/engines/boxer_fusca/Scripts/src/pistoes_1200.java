...
public class pistoes_1200 extends Piston
{
	public pistoes_1200( int id )
	{
		super( id );
		name = "Pistoes Motor Fusca 1200";
		description = "";
		...
		bore = 77.00;
		length_from_wrist_pin_center_to_crown_base = 33.00;// Piston Compression Height
