...
public class pistoes_1700 extends Piston
{
	public pistoes_1700( int id )
	{
		super( id );
		name = "Pistoes Puma Motor Fusca 1700";
		description = "";
		...
		bore = 88.00;
		length_from_wrist_pin_center_to_crown_base = 29.00;// Piston Compression Height
