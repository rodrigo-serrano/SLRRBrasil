...
public class cabecote_coletor_separado extends OHV_CylinderHead
{
	public cabecote_coletor_separado( int id )
	{
		super( id );
		name = "Cabecote Willys BF-161 Coletor Admissao Separado";
		description = "";
