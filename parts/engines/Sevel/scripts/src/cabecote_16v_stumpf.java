...
public class cabecote_16v_stumpf extends DOHC_CylinderHead
{
	public cabecote_16v_stumpf( int id )
	{
		super( id );
		name = "Cabecote Sevel 16v Retrabalhado Stumpft";
		description = "";
