...
public class sevel19turbo extends Set
{
	public sevel19turbo( int id )
	{
		super( id );
		name = "Motor Sevel 1.9 Turbo";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Sevel:0x00007CC1r ); // Coletor Escape
		inv.insertItem( parts.engines.Sevel:0x00006AA1r ); // Turbina
		...
		inv.insertItem( parts.engines.Sevel:0x000011C1r ); // Pressurizaçao
	}
}