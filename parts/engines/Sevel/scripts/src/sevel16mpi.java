...
public class sevel16mpi extends Set
{
	public sevel16mpi( int id )
	{
		super( id );
		name = "Motor Sevel 1.6 Injetado";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Sevel:0x0000117Fr ); // Cambio
		...
		inv.insertItem( parts.engines.Sevel:0x00002EA1r ); // Tampa Cabecote
		...
		inv.insertItem( parts.engines.Sevel:0x00005CA1r ); // Filtro
	}
}