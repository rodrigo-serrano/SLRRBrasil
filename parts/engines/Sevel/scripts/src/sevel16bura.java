...
public class sevel16bura extends Set
{
	public sevel16bura( int id )
	{
		super( id );
		name = "Motor Sevel 1.6 Carburado";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.Sevel:0x0000116Fr ); // Cambio
		...
		inv.insertItem( parts.engines.Sevel:0x00002FA1r ); // Tampa Cabecote
