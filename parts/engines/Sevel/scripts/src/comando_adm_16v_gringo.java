...
public class comando_adm_16v_gringo extends DOHC_Camshaft
{
	public comando_adm_16v_gringo( int id )
	{
		super( id );
		name = "Comando de Admissao Sevel 16v Importado Cat Cams";
		description = "";
		...
		static_input_lobe_separation	= 253.0;
