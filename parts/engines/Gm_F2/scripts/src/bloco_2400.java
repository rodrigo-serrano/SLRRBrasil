...
public class bloco_2400 extends Block_Inline_OHC
{
	public bloco_2400( int id )
	{
		super( id );
		name = "Bloco GM F2 2.4";
		description = "";
		...
		cylinder_length_from_top = 165.00;
		crank_center_to_cylinder_top = 235.00;
	...
	public void updatevariables()
	{
		...
		if (the_car)
		{
			...
			if (tab = the_car.getSfxTable(1))//off
			{
				...
				{
					if(dynodata.P_turbo_max == 1.99)
					tab.addItem(new ResourceRef(addon.Sounds.PureSound.General:0x00000010r), 5000, 2500.0, 18000.0, 2.0, 3.0);//bov 1
					else if(dynodata.P_turbo_max == 2.10)
					tab.addItem(new ResourceRef(addon.Sounds.PureSound.General:0x00000012r), 5000, 2500.0, 18000.0, 2.0, 3.0);//bov 2
				}
			}
