...
public class block_13 extends Block_Inline_OHC
{
	public block_13( int id )
	{
		super( id );
		name = "Bloco motor 1300-B";
		description = "Herdado da Renault Cleon engine o motor 1300-B (CHT 1.3) vinha inicialmente no Ford Corcel em 1967.";

		value = tHUF2USD(27.469);
		...
		crank_center_to_cylinder_top = 235.12;
		rpm_idle = 1000.0;
