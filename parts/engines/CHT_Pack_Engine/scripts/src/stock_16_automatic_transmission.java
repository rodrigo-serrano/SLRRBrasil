...
public class stock_16_automatic_transmission extends Transmission
{
	public stock_16_automatic_transmission( int id )
	{
		super( id );
		name = "Transmissao automatica motor CHT 1.6";
