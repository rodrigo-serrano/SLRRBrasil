...
public class stock_10_autolatina_transmission extends Transmission
{
	public stock_10_autolatina_transmission( int id )
	{
		super( id );
		name = "Transmissao motor AE-1000 (CHT 1.0)";
		description = "Relacao Gol CL 1000";

		value = tHUF2USD(62.210);
