...
public class exhaust_camshaft_13 extends DOHC_Camshaft
{
	public exhaust_camshaft_13( int id )
	{
		super( id );
		name = "Comando de exaustao CHT 1.3";
		description = "";
		...
		static_input_lobe_separation	= 205.5;
