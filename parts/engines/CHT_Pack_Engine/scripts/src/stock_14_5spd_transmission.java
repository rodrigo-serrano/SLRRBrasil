...
public class stock_14_5spd_transmission extends Transmission
{
	public stock_14_5spd_transmission( int id )
	{
		super( id );
		name = "Transmissao motor CHT 1.4 5spd";
		description = "Relacao Corcel II 1.4";

		value = tHUF2USD(71.210);
