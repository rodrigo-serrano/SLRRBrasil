...
public class cylinder_head_14 extends DOHC_CylinderHead
{
	public cylinder_head_14( int id )
	{
		super( id );
		name = "Cabecote motor CHT 1.4";
		description = "";

		value = tHUF2USD(31.704);
		...
		intake_valve_diam = 37.8;
		number_of_intake_valves_per_cylinder = 1.0;
		exhaust_valve_diam = 38.1;
