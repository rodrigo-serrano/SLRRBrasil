...
public class block_10 extends Block_Inline_OHC
{
	...
	{
		super( id );
		name = "Bloco motor CHT 1.0";
		description = "Em 1992 o CHT 1.0 e lancado ao mercado, com o proposito de economia de combustivel e, ate hoje, exelente para dirigir na cidade. Foi utilizado no Escort Hobby e no Gol 1000 rebatizando de AE (Alta-Economia).";
		...
		crank_center_to_cylinder_top = 234.02;
