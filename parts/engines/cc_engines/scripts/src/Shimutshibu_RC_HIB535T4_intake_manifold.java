...
public class Shimutshibu_RC_HIB535T4_intake_manifold extends IntakeManifold
{
	public Shimutshibu_RC_HIB535T4_intake_manifold( int id )
	{
		super( id );
		name = "Powertech 1.0 intake manifold";
		description = "";
