...
public class Einvagen_PerPro_GTA_intake_manifold extends IntakeManifold
{
	public Einvagen_PerPro_GTA_intake_manifold( int id )
	{
		super( id );
		name = "Volkswagen Sportive intake manifold";
		description = "";
