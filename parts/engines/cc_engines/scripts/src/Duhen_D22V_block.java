...
public class Duhen_D22V_block extends Block_Inline_OHC
{
	...
	{
		super( id );
		name = "Ford Endura-E 1.3 block";
		description = "Um motor com um exelente torque em baixa consegue ter boas retomadas, O Endura 1.3 equipou o Fiesta mk3 e Ford Ka entre 1994 e 1997.";
		...
		cylinder_length_from_top = 113.66;
		crank_center_to_cylinder_top = 215.67;

		rpm_idle = 850.0;
		time_spark_min	= sparkAngleTo4cycleTime(350.0);
		time_spark_inc	= sparkAngleTo4cycleTime(370.3)-time_spark_min;
