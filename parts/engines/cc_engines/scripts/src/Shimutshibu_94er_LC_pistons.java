...
public class Shimutshibu_94er_LC_pistons extends Piston
{
	public Shimutshibu_94er_LC_pistons( int id )
	{
		super( id );
		name = "Powertech MPFI pistons";
		description = "";
