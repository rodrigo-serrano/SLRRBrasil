...
public class Einvagen_110_GT_intake_camshaft extends DOHC_Camshaft
{
	public Einvagen_110_GT_intake_camshaft( int id )
	{
		super( id );
		name = "Volkswagen VHT 1.0 intake camshaft";
		description = "";
		...
		static_input_lobe_separation	= 265.0;
