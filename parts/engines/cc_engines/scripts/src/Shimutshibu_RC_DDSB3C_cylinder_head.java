...
public class Shimutshibu_RC_DDSB3C_cylinder_head extends DOHC_CylinderHead
{
	public Shimutshibu_RC_DDSB3C_cylinder_head( int id )
	{
		super( id );
		name = "Powertech MPFI cylinder head";
		description = "The stock head for the RC300.";

		value = tHUF2USD(4*7.5+65);
