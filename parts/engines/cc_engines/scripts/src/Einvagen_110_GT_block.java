...
public class Einvagen_110_GT_block extends Block_Inline_OHC
{
	...
	{
		super( id );
		name = "Volkswagen VHT 1.0 block";
		description = "Um dos projetos da Volks era criar um motor que tinha alto torque em baixa, sendo assim, o motor gastaria menos. O Motor surpreende pelo rendimento em baixa, mas como todo motor 1.0, sofre bastante para correr.";
		...
		crank_center_to_cylinder_top = 234.37;

		rpm_idle = 1000.0;
		time_spark_min	= sparkAngleTo4cycleTime(353.0);
