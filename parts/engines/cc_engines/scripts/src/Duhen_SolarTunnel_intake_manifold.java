...
public class Duhen_SolarTunnel_intake_manifold extends IntakeManifold
{
	public Duhen_SolarTunnel_intake_manifold( int id )
	{
		super( id );
		name = "Endura-E/Zetec Rocam 1.0 intake manifold";
		description = "This intake features 4 big bored even length tunnels and a 15.0 litre (920 cui) airbox to support the engine with enough fresh air.";
