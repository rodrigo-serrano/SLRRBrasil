...
public class Einvagen_PerPro_GTA_camshaft_drive_belt extends Part
{
	public Einvagen_PerPro_GTA_camshaft_drive_belt( int id )
	{
		super( id );
		name = "Volksvagen AT 1.0 16v camshaft drive belt";
