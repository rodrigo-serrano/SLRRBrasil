...
public class coletor_adm_2_quadrijet_trickflow extends IntakeManifold
{
	public coletor_adm_2_quadrijet_trickflow( int id )
	{
		super( id );
		name = "Coletor De Admissao Trickflow Duplo Quadrijet Dodge 318";
		description = "";
