...
public class coletor_adm_quadrijet_elderbrock extends IntakeManifold
{
	public coletor_adm_quadrijet_elderbrock( int id )
	{
		super( id );
		name = "Coletor De Admissao Edelbrock Quadrijet Dodge 318";
		description = "";
