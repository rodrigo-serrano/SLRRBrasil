...
public class carburador_2_quadrijet_demon extends FuelInjectorSystem
{
	public carburador_2_quadrijet_demon( int id )
	{
		super( id );
		name = "Dupla Quadrijet King Demon";
		description = "";
		brand_new_prestige_value = 115.95;
