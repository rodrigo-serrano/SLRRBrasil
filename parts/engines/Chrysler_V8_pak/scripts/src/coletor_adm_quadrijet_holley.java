...
public class coletor_adm_quadrijet_holley extends IntakeManifold
{
	public coletor_adm_quadrijet_holley( int id )
	{
		super( id );
		name = "Coletor De Admissao Alto Holley Quadrijet Dodge 318";
		description = "";
