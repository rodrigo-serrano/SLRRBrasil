...
public class coletor_adm_supercharles extends IntakeManifold
{
	public coletor_adm_supercharles( int id )
	{
		super( id );
		name = "Coletor De Admissao Edelbrock Para Supercharger Dodge 318";
		description = "";
