...
public class coletor_adm_quadrijet_holley2 extends IntakeManifold
{
	public coletor_adm_quadrijet_holley2( int id )
	{
		super( id );
		name = "Coletor De Admissao Baixo Holley Quadrijet Dodge 318";
		description = "";
