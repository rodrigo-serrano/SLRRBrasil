...
public class comando_elderbrock extends OHV_Camshaft
{
	public comando_elderbrock( int id )
	{
		super( id );
		name = "Comando Edelbrock Dodge 318 V8";
		description = "";
		...
		static_input_time_in_duration	= 245.0;
