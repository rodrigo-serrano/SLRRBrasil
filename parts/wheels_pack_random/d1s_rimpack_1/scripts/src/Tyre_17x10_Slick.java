...
public class Tyre_17x10_Slick extends Tyre
{
	public Tyre_17x10_Slick ( int id )
	{
		tyre_size_label = "255/30 R17";
		...
		render_types[10] = parts.wheels_pack_random:0x138r;      // for 10.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x138r;	// this rendertype as default //

		SetupTyre(255.0, 30.0, 17.0, 9.5, tcSUPERSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(255.0, 30.0, 17.0, rim.rim_width, tcDRAGRADIAL);
