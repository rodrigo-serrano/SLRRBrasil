...
public class tyre_3 extends Tyre
{
	public tyre_3 ( int id )
	{
		...
		render_types[10] = parts.wheels_pack_random:0x95r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x95r;	// this rendertype as default //
