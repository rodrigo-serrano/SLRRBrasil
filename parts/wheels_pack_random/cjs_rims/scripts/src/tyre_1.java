package java.game.parts.Cjs_Rims;

import java.game.parts.rgearpart.reciprocatingrgearpart.*;

public class tyre_1 extends Tyre
{
	public tyre_1 ( int id )
	{
		tyre_size_label = "195/25 R16";
		...
		render_types[10] = parts.wheels_pack_random:0x93r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x93r;	// this rendertype as default //

		SetupTyre(195.0, 25.0, 16.0, 10.0, tcSUPERSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(195.0, 25.0, 16.0, rim.rim_width, tcSUPERSPORT);
