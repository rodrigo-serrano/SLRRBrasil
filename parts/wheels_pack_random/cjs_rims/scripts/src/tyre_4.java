...
public class tyre_4 extends Tyre
{
	public tyre_4 ( int id )
	{
		...
		render_types[10] = parts.wheels_pack_random:0x96r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x96r;	// this rendertype as default //
