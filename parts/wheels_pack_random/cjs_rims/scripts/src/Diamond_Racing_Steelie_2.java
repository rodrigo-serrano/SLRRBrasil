...
public class Diamond_Racing_Steelie_2 extends Wheel
{
	float f_offset, default_offset, old_offset, diameter, width;

	public Diamond_Racing_Steelie_2 ( int id )
	{
		name = "Roda Diamond Racing Deep 16x10";
	...
	public void buildTuningMenu( Menu m )
	{
		...
		m.addItem( "Offset", 1, f_offset, -120.0, 120.0, 1.1, null ).printValue("   %1.1f");
