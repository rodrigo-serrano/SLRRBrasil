...
public class tyre_5 extends Tyre
{
	public tyre_5 ( int id )
	{
		...
		render_types[10] = parts.wheels_pack_random:0x97r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x97r;	// this rendertype as default //
