...
public class tire_1 extends Tyre
{
	public tire_1 ( int id )
	{
		tyre_size_label = "195/25 R17";
		...
		render_types[10] = parts.wheels_pack_random:0xA0r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0xA0r;	// this rendertype as default //

		SetupTyre(195.0, 25.0, 17.0, 10.0, tcSUPERSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(195.0, 25.0, 17.0, rim.rim_width, tcSUPERSPORT);
