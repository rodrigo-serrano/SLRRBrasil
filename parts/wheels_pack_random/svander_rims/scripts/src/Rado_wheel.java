...
public class Rado_wheel extends Wheel
{
	float f_offset, default_offset, old_offset, diameter, width;

	public Rado_wheel ( int id )
	{
		name = "Roda Volkswagen Corrado VR6 16x10";
	...
	public void buildTuningMenu( Menu m )
	{
		...
		m.addItem( "Offset", 1, f_offset, -125.0, 105.0, 1.1, null ).printValue("   %1.1f");
