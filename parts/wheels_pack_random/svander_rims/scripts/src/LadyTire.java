...
public class LadyTire extends Tyre
{
	public LadyTire ( int id )
	{
		tyre_size_label = "Fairlady Z-432 R16";
		...
		render_types[5] = parts.wheels_pack_random:0x56Dr;		// for  7.5 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x56Dr;	// this rendertype as default //

		SetupTyre(195.0, 40.0, 16.0, 7.5, tcSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(195.0, 40.0, 16.0, rim.rim_width, tcSPORT);
