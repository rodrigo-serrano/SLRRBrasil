...
public class Tyre_15 extends Tyre
{
	public Tyre_15 ( int id )
	{
		tyre_size_label = "ADVAN NEOVA 15 x 9.0 Perfil Alto";
		...
		render_types[8]  = parts.wheels_pack_random:0x576r;		// for  9.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x576r;	// this rendertype as default //

		SetupTyre(165.0, 50.0, 15.0, 9.0, tcSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(165.0, 50.0, 15.0, rim.rim_width, tcSPORT);
