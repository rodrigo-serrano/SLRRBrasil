...
public class r12tyre extends Tyre
{
	public r12tyre ( int id )
	{
		tyre_size_label = "ADVAN NEOVA 15 x 7.0 Perfil Alto";
		...
		render_types[4]  = parts.wheels_pack_random:0x570r;		// for  7.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x570r;	// this rendertype as default //

		SetupTyre(165.0, 30.0, 15.0, 7.0, tcSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(165.0, 30.0, 15.0, rim.rim_width, tcSPORT);
