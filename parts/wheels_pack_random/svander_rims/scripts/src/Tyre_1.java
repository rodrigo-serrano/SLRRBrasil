...
public class Tyre_1 extends Tyre
{
	public Tyre_1 ( int id )
	{
		...
		render_types[8]  = parts.wheels_pack_random:0x575r;		// for  9.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x575r;	// this rendertype as default //

		SetupTyre(165.0, 30.0, 15.0, 9.0, tcSPORT, 2.0);
