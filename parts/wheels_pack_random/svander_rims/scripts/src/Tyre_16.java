...
public class Tyre_16 extends Tyre
{
	public Tyre_16 ( int id )
	{
		tyre_size_label = "Citroen 16 x 7.0 Perfil Alto";
		...
		render_types[4]  = parts.wheels_pack_random:0x576r;		// for  7.0 inch wide rims //
		...
		SetupTyre(165.0, 30.0, 16.0, 7.0, tcSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(165.0, 30.0, 16.0, rim.rim_width, tcSPORT);
