...
public class xr2irim extends Wheel
{
	float f_offset, default_offset, old_offset, diameter, width;

	public xr2irim ( int id )
	{
		name = "Roda Ford Fiesta MK3 XR2i 15x9";
	...
	public void buildTuningMenu( Menu m )
	{
		...
		m.addItem( "Offset", 1, f_offset, -105.0, 105.0, 1.1, null ).printValue("   %1.1f");
