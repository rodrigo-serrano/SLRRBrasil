...
public class rim_11 extends Wheel
{
	float f_offset, default_offset, old_offset, diameter, width;

	public rim_11 ( int id )
	{
		name = "Roda Diplomata Cromada 17x8";
		...
		value = tHUF2USD(288.46153846153846153846153846154);
		brand_new_prestige_value = 144.23076923076923076923076923077;
		setMaxWear(kmToMaxWear(500000.0));

		description = "Model By:Silva92.";
	}
