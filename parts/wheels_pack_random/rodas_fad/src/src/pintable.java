...
public class pintable extends Wheel
{
	float f_offset, default_offset, old_offset, diameter, width;

	public pintable ( int id )
	{
		name = "Roda Repolho Pintavel Opala";
				rim_type = rtFACTORY;
		diameter = 15.0;
		width = 8.0;
		default_offset = 0.0;
		...
		description = "Rodas com offset variavel, estilo repolho pintavel para a linha Opala, por FAD 22 SLRR BR.";
	}
