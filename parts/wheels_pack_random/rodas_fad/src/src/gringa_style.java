package java.game.parts.rodas_fad;
...
public class gringa_style extends Wheel
{
	float f_offset, default_offset, old_offset, diameter, width;

	public gringa_style ( int id )
	{
		name = "Roda Repolho Estilo Gringa Opala";
				rim_type = rtFACTORY;
		diameter = 15.0;
		width = 8.0;
		default_offset = 0.0;
		...
		description = "Rodas com offset variavel, estilo repolho gringa para a linha Opala, por FAD 22 SLRR BR.";
	}
