...
public class roda_diplo extends Wheel
{
	float f_offset, default_offset, old_offset, diameter, width;

	public roda_diplo ( int id )
	{
		name = "Roda Opala Diplomata 92 15x8";
		rim_type = rtFACTORY;
		diameter = 15.0;
		width = 8.0;
		default_offset = 0.0;
		...
		description = "Rodas com offset variavel, estilo Diplomata 92 para a linha Opala, por FAD 22 SLRR BR.";
	}
