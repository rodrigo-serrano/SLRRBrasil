...
public class ralinho extends Wheel
{
	float f_offset, default_offset, old_offset, diameter, width;

	public ralinho ( int id )
	{
		name = "Roda Ralinho Opala 15x8";
		rim_type = rtFACTORY;
		diameter = 15.0;
		width = 8.0;
		default_offset = 0.0;
		...
		description = "Rodas com offset variavel, estilo ralinho para a linha Opala, por FAD 22 SLRR BR.";
	}
