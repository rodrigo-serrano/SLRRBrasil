...
public class Tyre_3 extends Tyre
{
	...
	{
		tyre_size_label = "ADVAN NEOVA 14 x 9.0 Perfil Alto";
		...
		render_types[8]  = parts.wheels_pack_random:0x4FDr;		// for  9.0 inch wide rims //
		...
		render_types[21] = parts.wheels_pack_random:0x4FDr;	// this rendertype as default //

		SetupTyre(165.0, 30.0, 14.0, 9.0, tcSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(165.0, 30.0, 14.0, rim.rim_width, tcSPORT);
