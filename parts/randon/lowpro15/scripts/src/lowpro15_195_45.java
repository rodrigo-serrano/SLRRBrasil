...
public class lowpro15_195_45 extends Tyre
{
	public lowpro15_195_45 ( int id )
	{
		tyre_size_label = "195/45 R15";
		...
		render_types[4]  = parts.randon:0x93r;		// for  7.0 inch wide rims //
		render_types[5]  = parts.randon:0x93r;		// for  7.5 inch wide rims //
		render_types[6]  = parts.randon:0x93r;		// for  8.0 inch wide rims //
		render_types[7]  = parts.randon:0x93r;		// for  8.5 inch wide rims //
		render_types[8]  = parts.randon:0x93r;	 	// for  9.0 inch wide rims //
		...
		render_types[21] = parts.randon:0x93r;	// this rendertype as default //

		SetupTyre(195.0, 45.0, 15.0, 7.5, tcSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(195.0, 45.0, 15.0, rim.rim_width, tcSPORT);
