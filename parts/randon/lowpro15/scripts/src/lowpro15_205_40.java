...
public class lowpro15_205_40 extends Tyre
{
	public lowpro15_205_40 ( int id )
	{
		...
		render_types[4]  = parts.randon:0x95r;		// for  7.0 inch wide rims //
		render_types[5]  = parts.randon:0x95r;		// for  7.5 inch wide rims //
		render_types[6]  = parts.randon:0x95r;		// for  8.0 inch wide rims //
		render_types[7]  = parts.randon:0x95r;		// for  8.5 inch wide rims //
		render_types[8]  = parts.randon:0x95r;	 	// for  9.0 inch wide rims //
		...
		render_types[21] = parts.randon:0x95r;	// this rendertype as default //

		SetupTyre(205.0, 40.0, 15.0, 7.5, tcSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(205.0, 40.0, 15.0, rim.rim_width, tcSPORT);
