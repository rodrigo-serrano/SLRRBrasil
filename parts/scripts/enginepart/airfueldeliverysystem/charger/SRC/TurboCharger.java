...
public class TurboCharger extends Charger
{
	...
	public void buildTuningMenu( Menu m )
	{
		...
		m.addItem( "Pressao de Turbo", 1, P_turbo_waste, min_waste, max_waste, (max_waste-min_waste)/0.05+1, null ).changeVLabelText( Float.toString(P_turbo_waste, " %1.2f bar") + Float.toString(P_turbo_waste*14.7, " %1.2f psi") );
	}
