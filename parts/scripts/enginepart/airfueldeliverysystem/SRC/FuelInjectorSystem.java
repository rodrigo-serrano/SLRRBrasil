...
public class FuelInjectorSystem extends AirFuelDeliverySystem
{
	...
	int	default_fuel_type1	= FT_GAS_98;
	int	default_fuel_type2	= FT_GAS_100;
	int	default_fuel_type3	= FT_METHANOL;
	...
	public void buildTuningMenu( Menu m )
	{
		...
		fuelTypes[0] = "Gasolina Comum";
		fuelTypes[1] = "Gasolina Podium";
		fuelTypes[2] = "Alcool";

		old_mixture_ratio = mixture_ratio;
		m.addItem( "Sonda Lambda AFR",		1, mixture_ratio, 8.0, 20.0, 49, null ).printValue("   %1.2f:1 A/F");
		old_fuel_type = fuel_type;
		m.addItem( "Combustivel",			2, fuel_type, fuelTypes, null );
	}
