...
public class NOSInjectorSystem extends AirFuelDeliverySystem
{
	...
	public void fillDynoData( DynoData dd, int parentSlot )
	{
		...
		nitro_H = 2.01;
		nitro_cooling = 2.3 - nitro_consumption*0.0666;

		dd.nitro_H = nitro_H;
		dd.nitro_cooling = nitro_cooling;
		dd.nitro_consumption = nitro_consumption*0.333;
		dd.nitropower = nitro_consumption*132.353/3.6;
...
//		dd.nitro_minThrottle = nitro_minThrottle;
	...
	public void buildTuningMenu( Menu m )
	{
		...
		m.addItem( "Quantidade Injetada", 1, nitro_consumption, minconsumption, maxconsumption, 0, null ).changeVLabelText( Float.toString(nitro_consumption*132.277*1/3.6, "%1.0f hp"));
	}
	...
	public void handleMessage( Event m )
	{
		if( m.cmd == 1 )
		{
			...
			((Slider)m.gadget).changeVLabelText( Float.toString(nitro_consumption*132.277*1/3.6, "%1.0f hp"));
		}
	}
	//---------tuning
}
