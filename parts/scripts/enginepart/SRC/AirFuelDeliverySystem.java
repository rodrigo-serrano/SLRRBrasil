...
public class AirFuelDeliverySystem extends EnginePart
{
	...
	public void calcStuffs()
	{
		...
		if (fuel_type == FT_DIESEL)
			...
			optimal_mixture_ratio = 14.7/1.0; // FT_GAS_95 //
	}
...
//			System.log("  fuel type: 98 octane pump gas");
			H = 1105000.0;
			optimal_mixture_ratio = 13.50/1.0;
...
//			System.log("  fuel type: 100 octane premium gas");
			H = 1200000.0;
			optimal_mixture_ratio = 9.00/1.0;
			optimal_burn_time_base	= 0.00243;
			optimal_burn_time_offset= 0.00070;
		}
		else
		if (ft == FT_METHANOL)
		{
