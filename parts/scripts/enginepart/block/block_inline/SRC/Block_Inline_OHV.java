package java.game.parts.enginepart.block.block_inline;
...
public class Block_Inline_OHV extends Block_Inline
{
	int	camshaft_slot_ID = 0;
	int	camshaft_bearing_slot_ID = 0;

	public Block_Inline_OHV(){}

	public Block_Inline_OHV( int id )
	{
		super( id );
	}
...
//			System.log("!!!Camshaft bearing bridge required on slot!!!");
	...
	{
//		System.log("--------------------------------------");
//		System.log("Block_Inline_OHV updatevariables() called");
//		System.log("--------------------------------------");
...
//			System.log(">>"+name+", Block_Inline_OHV.JAVA<<:");
