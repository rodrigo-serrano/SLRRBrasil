package java.game.parts.tiref15;

import java.game.parts.rgearpart.reciprocatingrgearpart.*;

public class tyre_01 extends Tyre
{
	public tyre_01 ( int id )
	{
		tyre_size_label = "225/35 R15";
		...
		render_types[7]  = parts.pneus:0x23Cr;	// for  8.5 inch wide rims //
		render_types[8]  = parts.pneus:0x23Cr;	// for  9.0 inch wide rims //
		render_types[9]  = parts.pneus:0x23Cr;	// for  9.5 inch wide rims //
		render_types[10] = parts.pneus:0x23Cr;	// for 10.0 inch wide rims //
		render_types[11] = parts.pneus:0x23Cr;	// for 10.5 inch wide rims //
		render_types[12] = parts.pneus:0x23Cr;	// for 11.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x23Cr;	// this rendertype as default //

		SetupTyre(225.0, 35.0, 15.0, 9.0, tcSUPERSPORT, 2.0);

		name = "stretched Pirelli P Zero 225/35/R15";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(225.0, 35.0, 15.0, rim.rim_width, tcSUPERSPORT);
