...
public class regular_16 extends Tyre
{
	public regular_16( int id )
	{
		...
		render_types[10] = parts.pneus:0x162r;	// for 10.0 inch wide rims //
		render_types[11] = parts.pneus:0x162r;	// for 10.5 inch wide rims //
		render_types[12] = parts.pneus:0x162r;	// for 11.0 inch wide rims //
		render_types[13] = parts.pneus:0x162r;	// for 11.5 inch wide rims //
		render_types[14] = parts.pneus:0x162r;	// for 12.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x162r;	// this rendertype as default //

		SetupTyre(215.0, 18.0, 16.0, 10.0, tcSUPERSPORT, 2.0);

		name = "BF Goodrich Streched 205/55 R16";
