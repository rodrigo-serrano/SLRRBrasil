...
public class toyo20 extends Tyre
{
	public toyo20( int id )
	{
		...
		render_types[10] = parts.pneus:0x16Br;	// for 10.0 inch wide rims //
		render_types[11] = parts.pneus:0x16Br;	// for 10.5 inch wide rims //
		render_types[12] = parts.pneus:0x16Br;	// for 11.0 inch wide rims //
		render_types[13] = parts.pneus:0x16Br;	// for 11.5 inch wide rims //
		render_types[14] = parts.pneus:0x16Br;	// for 12.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x16Br;	// this rendertype as default //

		SetupTyre(255.0, 24.0, 20.0, 11.0, tcSUPERSPORT, 2.0);

		name = "Toyo R888 255/55 ZR20";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(255.0, 24.0, 20.0, rim.rim_width, tcSUPERSPORT);
