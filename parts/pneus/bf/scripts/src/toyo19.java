...
public class toyo19 extends Tyre
{
	public toyo19( int id )
	{
		...
		render_types[10] = parts.pneus:0x16Ar;	// for 10.0 inch wide rims //
		render_types[11] = parts.pneus:0x16Ar;	// for 10.5 inch wide rims //
		render_types[12] = parts.pneus:0x16Ar;	// for 11.0 inch wide rims //
		render_types[13] = parts.pneus:0x16Ar;	// for 11.5 inch wide rims //
		render_types[14] = parts.pneus:0x16Ar;	// for 12.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x16Ar;	// this rendertype as default //

		SetupTyre(255.0, 23.0, 19.0, 11.0, tcSUPERSPORT, 2.0);

		name = "Toyo R888 255/55 ZR19";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(255.0, 23.0, 19.0, rim.rim_width, tcSUPERSPORT);
