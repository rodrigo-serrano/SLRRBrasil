...
public class toyos16 extends Tyre
{
	public toyos16( int id )
	{
		...
		render_types[10] = parts.pneus:0x16Cr;	// for 10.0 inch wide rims //
		render_types[11] = parts.pneus:0x16Cr;	// for 10.5 inch wide rims //
		render_types[12] = parts.pneus:0x16Cr;	// for 11.0 inch wide rims //
		render_types[13] = parts.pneus:0x16Cr;	// for 11.5 inch wide rims //
		render_types[14] = parts.pneus:0x16Cr;	// for 12.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x16Cr;	// this rendertype as default //

		SetupTyre(215.0, 18.0, 16.0, 10.0, tcSUPERSPORT, 2.0);

		name = "Toyo R888 Streched 205/55 R16";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(215.0, 18.0, 16.0, rim.rim_width, tcSUPERSPORT);
