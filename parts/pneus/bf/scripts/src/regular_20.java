...
public class regular_20 extends Tyre
{
	public regular_20( int id )
	{
		tyre_size_label = "255/25 R20";
		...
		render_types[10] = parts.pneus:0x166r;	// for 10.0 inch wide rims //
		render_types[11] = parts.pneus:0x166r;	// for 10.5 inch wide rims //
		render_types[12] = parts.pneus:0x166r;	// for 11.0 inch wide rims //
		render_types[13] = parts.pneus:0x166r;	// for 11.5 inch wide rims //
		render_types[14] = parts.pneus:0x166r;	// for 12.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x166r;	// this rendertype as default //

		SetupTyre(255.0, 18.0, 20.0, 11.0, tcSUPERSPORT, 2.0);

		name = "BF Goodrich Streched 255/55 ZR20";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(255.0, 18.0, 20.0, rim.rim_width, tcSUPERSPORT);
