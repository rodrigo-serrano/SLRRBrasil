...
public class toyo16 extends Tyre
{
	public toyo16( int id )
	{
		...
		render_types[10] = parts.pneus:0x167r;	// for 10.0 inch wide rims //
		render_types[11] = parts.pneus:0x167r;	// for 10.5 inch wide rims //
		render_types[12] = parts.pneus:0x167r;	// for 11.0 inch wide rims //
		render_types[13] = parts.pneus:0x167r;	// for 11.5 inch wide rims //
		render_types[14] = parts.pneus:0x167r;	// for 12.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x167r;	// this rendertype as default //

		SetupTyre(215.0, 23.0, 16.0, 10.0, tcSUPERSPORT, 2.0);

		name = "Toyo R888 205/55 R16";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(215.0, 23.0, 16.0, rim.rim_width, tcSUPERSPORT);
