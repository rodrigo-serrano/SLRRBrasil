...
public class exposed_16 extends Tyre
{
	public exposed_16( int id )
	{
		...
		render_types[10] = parts.pneus:0x19Dr;	// for 10.0 inch wide rims //
		render_types[11] = parts.pneus:0x19Dr;	// for 10.5 inch wide rims //
		render_types[12] = parts.pneus:0x19Dr;	// for 11.0 inch wide rims //
		render_types[13] = parts.pneus:0x19Dr;	// for 11.5 inch wide rims //
		render_types[14] = parts.pneus:0x19Dr;	// for 12.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x19Dr;	// this rendertype as default //

		SetupTyre(215.0, 20.0, 16.0, 10.0, tcSUPERSPORT, 2.0);

		name = "Exposed Lip Supersport Tyre 215/15 R16";
