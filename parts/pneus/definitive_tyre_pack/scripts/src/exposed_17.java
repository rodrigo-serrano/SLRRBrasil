...
public class exposed_17 extends Tyre
{
	public exposed_17( int id )
	{
		...
		render_types[3]  = parts.pneus:0x19Er;	// for  6.5 inch wide rims //
		render_types[4]  = parts.pneus:0x19Er;	// for  7.0 inch wide rims //
		render_types[5]  = parts.pneus:0x19Er;	// for  7.5 inch wide rims //
		render_types[6]  = parts.pneus:0x19Er;	// for  8.0 inch wide rims //
		render_types[7]  = parts.pneus:0x19Er;	// for  8.5 inch wide rims //
		render_types[8]  = parts.pneus:0x19Er;	// for  9.0 inch wide rims //
		render_types[9]  = parts.pneus:0x19Er;	// for  9.5 inch wide rims //
		render_types[10] = parts.pneus:0x19Er;		// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x19Er;	// this rendertype as default //

		SetupTyre(245.0, 18.0, 17.0, 10.0, tcSPORT, 2.0);

		calcStuffs();

		name = " Exposed Lip Sport Tyre 245/25 R17";
		value = 600.0;
	}
