...
public class stretch_18 extends Tyre
{
	public stretch_18( int id )
	{
		...
		render_types[3]  = parts.pneus:0x1A7r;	// for  6.5 inch wide rims //
		render_types[4]  = parts.pneus:0x1A7r;	// for  7.0 inch wide rims //
		render_types[5]  = parts.pneus:0x1A7r;	// for  7.5 inch wide rims //
		render_types[6]  = parts.pneus:0x1A7r;	// for  8.0 inch wide rims //
		render_types[7]  = parts.pneus:0x1A7r;	// for  8.5 inch wide rims //
		render_types[8]  = parts.pneus:0x1A7r;	// for  9.0 inch wide rims //
		render_types[9]  = parts.pneus:0x1A7r;	// for  9.5 inch wide rims //
		render_types[10] = parts.pneus:0x1A7r;		// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x1A7r;	// this rendertype as default //

		SetupTyre(255.0, 14.0, 18.0, 11.0, tcSUPERSPORT, 2.0);

		calcStuffs();

		name = "Stretched Supersport Tyre 255/20 R18";
		value = 600.0;
	}
