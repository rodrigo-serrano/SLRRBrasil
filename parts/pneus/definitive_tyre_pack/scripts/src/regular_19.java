...
public class regular_19 extends Tyre
{
	public regular_19( int id )
	{
		...
		render_types[10] = parts.pneus:0x1A4r;	// for 10.0 inch wide rims //
		render_types[11] = parts.pneus:0x1A4r;	// for 10.5 inch wide rims //
		render_types[12] = parts.pneus:0x1A4r;	// for 11.0 inch wide rims //
		render_types[13] = parts.pneus:0x1A4r;	// for 11.5 inch wide rims //
		render_types[14] = parts.pneus:0x1A4r;	// for 12.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x1A4r;	// this rendertype as default //

		SetupTyre(255.0, 20.0, 19.0, 11.0, tcSUPERSPORT, 2.0);

		name = "Regular supersport 255/25 ZR19";
