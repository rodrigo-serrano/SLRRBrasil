...
public class Sava_s_16 extends Tyre
{
	public Sava_s_16( int id )
	{
		...
		render_types[10] = parts.BB93_3D_tyres_2:0x0000024Dr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.BB93_3D_tyres_2:0x0000024Dr;	// this rendertype as default //

		SetupTyre(215.0, 23.0, 16.0, 10.0, tcSPORT, 2.0);

		name = "BB's Sava Eskimo Stretched 215/25 R16";
