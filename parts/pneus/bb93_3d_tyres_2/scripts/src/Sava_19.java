...
public class Sava_19 extends Tyre
{
	public Sava_19( int id )
	{
		...
		render_types[12] = parts.BB93_3D_tyres_2:0x00000241r;	// for 11.0 inch wide rims //
		...
		render_types[21] = parts.BB93_3D_tyres_2:0x00000241r;	// this rendertype as default //

		SetupTyre(255.0, 23.0, 19.0, 11.0, tcSPORT, 2.0);

		name = "BB's Sava Eskimo 255/25 ZR19";
