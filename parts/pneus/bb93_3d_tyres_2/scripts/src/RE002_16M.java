...
public class RE002_16M extends Tyre
{
	public RE002_16M( int id )
	{
		...
		render_types[10] = parts.pneus:0x131r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x131r;	// this rendertype as default //

		SetupTyre(215.0, 36.0, 16.0, 10.0, tcSPORT, 2.0);

		name = "BB's Bridgestone Potenza RE002 215/40 R16";
