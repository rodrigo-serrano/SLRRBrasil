...
public class Direzza_15 extends Tyre
{
	public Direzza_15( int id )
	{
		tyre_size_label = "245/20 R15";
		...
		render_types[7]  = parts.pneus:0xDr;		// for  8.5 inch wide rims //
		render_types[8]  = parts.pneus:0xDr;	// for  9.0 inch wide rims //
		render_types[9]  = parts.pneus:0xDr;		// for  9.5 inch wide rims //
		render_types[10] = parts.pneus:0xDr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0xDr;	// this rendertype as default //

		SetupTyre(245.0, 16.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Dunlop Direzza 245/20 R15";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(245.0, 16.0, 15.0, rim.rim_width, tcSPORT);
