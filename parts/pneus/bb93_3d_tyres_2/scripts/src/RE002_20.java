...
public class RE002_20 extends Tyre
{
	public RE002_20( int id )
	{
		...
		render_types[12] = parts.pneus:0x81r;	// for 11.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x81r;	// this rendertype as default //

		SetupTyre(275.0, 22.0, 20.0, 11.0, tcSPORT, 2.0);

		name = "BB's Bridgestone Potenza RE002 275/25 ZR20";
