...
public class Direzza_15H extends Tyre
{
	public Direzza_15H( int id )
	{
		...
		render_types[10] = parts.pneus:0xCDr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0xCDr;	// this rendertype as default //

		SetupTyre(245.0, 42.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Dunlop Direzza 245/45 R15";
