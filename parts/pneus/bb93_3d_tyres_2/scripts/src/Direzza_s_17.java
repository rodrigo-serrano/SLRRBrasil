...
public class Direzza_s_17 extends Tyre
{
	public Direzza_s_17( int id )
	{
		...
		render_types[10] = parts.pneus:0x2Dr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x2Dr;	// this rendertype as default //

		SetupTyre(245.0, 22.0, 17.0, 10.0, tcSPORT, 2.0);

		name = "BB's Dunlop Direzza Stretched 245/20 R17";
