...
public class Pilot_s_16M extends Tyre
{
	public Pilot_s_16M( int id )
	{
		...
		render_types[10] = parts.pneus:0x129r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x129r;	// this rendertype as default //

		SetupTyre(215.0, 36.0, 16.0, 10.0, tcSPORT, 2.0);

		name = "BB's Michelin Pilot Stretched 215/40 R16";
