...
public class Pilot_15 extends Tyre
{
	public Pilot_15( int id )
	{
		...
		render_types[10] = parts.pneus:0x3Dr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x3Dr;	// this rendertype as default //

		SetupTyre(245.0, 16.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Michelin Pilot 245/20 R15";
