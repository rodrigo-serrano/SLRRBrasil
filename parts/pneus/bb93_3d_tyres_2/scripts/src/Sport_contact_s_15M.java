...
public class Sport_contact_s_15M extends Tyre
{
	public Sport_contact_s_15M( int id )
	{
		tyre_size_label = "245/35 R15";
		...
		render_types[10] = parts.pneus:0x149r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x149r;	// this rendertype as default //

		SetupTyre(245.0, 35.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact Stretched 245/35 R15";
