...
public class Sava_15 extends Tyre
{
	public Sava_15( int id )
	{
		...
		render_types[10] = parts.BB93_3D_tyres_2:0x00000231r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.BB93_3D_tyres_2:0x00000231r;	// this rendertype as default //

		SetupTyre(245.0, 19.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Sava Eskimo 245/20 R15";
