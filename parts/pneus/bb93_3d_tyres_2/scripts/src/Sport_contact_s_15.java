...
public class Sport_contact_s_15 extends Tyre
{
	public Sport_contact_s_15( int id )
	{
		...
		render_types[10] = parts.pneus:0xB5r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0xB5r;	// this rendertype as default //

		SetupTyre(245.0, 16.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact Stretched 245/20 R15";
