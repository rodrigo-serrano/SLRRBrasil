...
public class Sport_contact_s_15H extends Tyre
{
	public Sport_contact_s_15H( int id )
	{
		tyre_size_label = "245/45 R15";
		...
		render_types[10] = parts.pneus:0x105r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x105r;	// this rendertype as default //

		SetupTyre(245.0, 42.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact Stretched 245/45 R15";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(245.0, 42.0, 15.0, rim.rim_width, tcSPORT);
