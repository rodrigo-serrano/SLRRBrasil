...
public class Pilot_20 extends Tyre
{
	public Pilot_20( int id )
	{
		...
		render_types[12] = parts.pneus:0x51r;	// for 11.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x51r;	// this rendertype as default //

		SetupTyre(275.0, 22.0, 20.0, 11.0, tcSPORT, 2.0);

		name = "BB's Michelin Pilot 275/25 ZR20";
