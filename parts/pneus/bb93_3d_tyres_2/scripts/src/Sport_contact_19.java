...
public class Sport_contact_19 extends Tyre
{
	public Sport_contact_19( int id )
	{
		...
		render_types[12] = parts.pneus:0xADr;	// for 11.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0xADr;	// this rendertype as default //

		SetupTyre(255.0, 23.0, 19.0, 11.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact 255/25 ZR19";
