...
public class Sport_contact_s_16H extends Tyre
{
	public Sport_contact_s_16H( int id )
	{
		tyre_size_label = "215/50 R16";
		...
		render_types[10] = parts.pneus:0x109r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x109r;	// this rendertype as default //

		SetupTyre(215.0, 50.0, 16.0, 10.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact Stretched 215/50 R16";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(215.0, 50.0, 16.0, rim.rim_width, tcSPORT);
