...
public class RE002_15 extends Tyre
{
	public RE002_15( int id )
	{
		...
		render_types[10] = parts.pneus:0x6Dr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x6Dr;	// this rendertype as default //

		SetupTyre(245.0, 16.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Bridgestone Potenza RE002 245/20 R15";
