...
public class RE002_16H extends Tyre
{
	public RE002_16H( int id )
	{
		...
		render_types[10] = parts.pneus:0xF1r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0xF1r;	// this rendertype as default //

		SetupTyre(215.0, 50.0, 16.0, 10.0, tcSPORT, 2.0);

		name = "BB's Bridgestone Potenza RE002 215/50 R16";
