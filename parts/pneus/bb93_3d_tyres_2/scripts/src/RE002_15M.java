...
public class RE002_15M extends Tyre
{
	public RE002_15M( int id )
	{
		...
		render_types[10] = parts.pneus:0x12Dr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x12Dr;	// this rendertype as default //

		SetupTyre(245.0, 35.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Bridgestone Potenza RE002 245/35 R15";
