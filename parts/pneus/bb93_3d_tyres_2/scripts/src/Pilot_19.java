...
public class Pilot_19 extends Tyre
{
	public Pilot_19( int id )
	{
		...
		render_types[12] = parts.pneus:0x4Dr;	// for 11.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x4Dr;	// this rendertype as default //

		SetupTyre(255.0, 23.0, 19.0, 11.0, tcSPORT, 2.0);

		name = "BB's Michelin Pilot 255/25 ZR19";
