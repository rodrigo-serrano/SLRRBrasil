...
public class Sport_contact_18 extends Tyre
{
	public Sport_contact_18( int id )
	{
		...
		render_types[10] = parts.pneus:0xA9r;		// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0xA9r;	// this rendertype as default //

		SetupTyre(255.0, 21.0, 18.0, 11.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact 255/20 R18";
