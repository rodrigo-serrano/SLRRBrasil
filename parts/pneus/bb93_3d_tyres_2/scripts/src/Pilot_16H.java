...
public class Pilot_16H extends Tyre
{
	public Pilot_16H( int id )
	{
		...
		render_types[10] = parts.pneus:0xE1r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0xE1r;	// this rendertype as default //

		SetupTyre(215.0, 50.0, 16.0, 10.0, tcSPORT, 2.0);

		name = "BB's Michelin Pilot 215/50 R16";
