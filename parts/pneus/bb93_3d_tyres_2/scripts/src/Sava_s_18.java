...
public class Sava_s_18 extends Tyre
{
	public Sava_s_18( int id )
	{
		...
		render_types[10] = parts.BB93_3D_tyres_2:0x00000255r;		// for 10.0 inch wide rims //
		...
		render_types[21] = parts.BB93_3D_tyres_2:0x00000255r;	// this rendertype as default //

		SetupTyre(255.0, 21.0, 18.0, 11.0, tcSPORT, 2.0);

		name = "BB's Sava Eskimo Stretched 255/20 R18";
