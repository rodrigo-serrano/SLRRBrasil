...
public class Sava_20 extends Tyre
{
	public Sava_20( int id )
	{
		...
		render_types[12] = parts.BB93_3D_tyres_2:0x00000245r;	// for 11.0 inch wide rims //
		...
		render_types[21] = parts.BB93_3D_tyres_2:0x00000245r;	// this rendertype as default //

		SetupTyre(275.0, 22.0, 20.0, 11.0, tcSPORT, 2.0);

		name = "BB's Sava Eskimo 275/25 ZR20";
