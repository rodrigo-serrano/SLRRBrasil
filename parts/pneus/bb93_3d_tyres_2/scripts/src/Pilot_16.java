...
public class Pilot_16 extends Tyre
{
	public Pilot_16( int id )
	{
		...
		render_types[10] = parts.pneus:0x41r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x41r;	// this rendertype as default //

		SetupTyre(215.0, 23.0, 16.0, 10.0, tcSPORT, 2.0);

		name = "BB's Michelin Pilot 215/25 R16";
