...
public class Sport_contact_15H extends Tyre
{
	public Sport_contact_15H( int id )
	{
		...
		render_types[10] = parts.pneus:0xFDr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0xFDr;	// this rendertype as default //

		SetupTyre(245.0, 42.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact 245/45 R15";
