...
public class Direzza_19 extends Tyre
{
	public Direzza_19( int id )
	{
		...
		render_types[12] = parts.pneus:0x1Dr;	// for 11.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x1Dr;	// this rendertype as default //

		SetupTyre(255.0, 23.0, 19.0, 11.0, tcSPORT, 2.0);

		name = "BB's Dunlop Direzza 255/25 ZR19";
