...
public class Sport_contact_15M8 extends Tyre
{
	public Sport_contact_15M8( int id )
	{
		tyre_size_label = "215/45 R15";
		...
		render_types[6]  = parts.pneus:0x13Fr;		// for  8.0 inch wide rims //
		render_types[7]  = parts.pneus:0x13Fr;		// for  8.5 inch wide rims //
		render_types[8]  = parts.pneus:0x13Fr;		// for  9.0 inch wide rims //
		render_types[9]  = parts.pneus:0x13Fr;		// for  9.5 inch wide rims //
		render_types[10] = parts.pneus:0x13Fr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x13Fr;	// this rendertype as default //

		SetupTyre(215.0, 45.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact 215/45 R15 8j Rims";
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(245.0, 35.0, 15.0, rim.rim_width, tcSPORT);
