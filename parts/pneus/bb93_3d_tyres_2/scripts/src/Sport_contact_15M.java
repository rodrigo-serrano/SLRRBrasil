...
public class Sport_contact_15M extends Tyre
{
	public Sport_contact_15M( int id )
	{
		...
		render_types[10] = parts.pneus:0x13Er;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x13Er;	// this rendertype as default //

		SetupTyre(245.0, 35.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact 245/35 R15";
