...
public class Pilot_15H extends Tyre
{
	public Pilot_15H( int id )
	{
		...
		render_types[10] = parts.pneus:0xDDr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0xDDr;	// this rendertype as default //

		SetupTyre(245.0, 42.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Michelin Pilot 245/45 R15";
