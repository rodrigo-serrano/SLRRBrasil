...
public class Pilot_s_17 extends Tyre
{
	public Pilot_s_17( int id )
	{
		...
		render_types[10] = parts.pneus:0x5Dr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x5Dr;	// this rendertype as default //

		SetupTyre(245.0, 22.0, 17.0, 10.0, tcSPORT, 2.0);

		name = "BB's Michelin Pilot Stretched 245/20 R17";
