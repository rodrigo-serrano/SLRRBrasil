...
public class Direzza_16M extends Tyre
{
	public Direzza_16M( int id )
	{
		...
		render_types[10] = parts.pneus:0x111r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x111r;	// this rendertype as default //

		SetupTyre(215.0, 36.0, 16.0, 10.0, tcSPORT, 2.0);

		name = "BB's Dunlop Direzza 215/40 R16";
