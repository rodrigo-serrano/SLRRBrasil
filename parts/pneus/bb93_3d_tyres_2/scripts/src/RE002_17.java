...
public class RE002_17 extends Tyre
{
	public RE002_17( int id )
	{
		...
		render_types[10] = parts.pneus:0x75r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x75r;	// this rendertype as default //

		SetupTyre(245.0, 22.0, 17.0, 10.0, tcSPORT, 2.0);

		name = "BB's Bridgestone Potenza RE002 245/20 R17";
