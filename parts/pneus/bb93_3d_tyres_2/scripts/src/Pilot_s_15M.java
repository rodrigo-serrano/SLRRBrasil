...
public class Pilot_s_15M extends Tyre
{
	public Pilot_s_15M( int id )
	{
		...
		render_types[10] = parts.pneus:0x125r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x125r;	// this rendertype as default //

		SetupTyre(245.0, 35.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Michelin Pilot Stretched 245/35 R15";
