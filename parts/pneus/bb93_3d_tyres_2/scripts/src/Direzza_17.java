...
public class Direzza_17 extends Tyre
{
	public Direzza_17( int id )
	{
		...
		render_types[10] = parts.pneus:0x15r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x15r;	// this rendertype as default //

		SetupTyre(245.0, 22.0, 17.0, 10.0, tcSPORT, 2.0);

		name = "BB's Dunlop Direzza 245/20 R17";
