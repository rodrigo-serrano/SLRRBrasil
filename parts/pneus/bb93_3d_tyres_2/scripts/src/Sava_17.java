...
public class Sava_17 extends Tyre
{
	public Sava_17( int id )
	{
		...
		render_types[10] = parts.BB93_3D_tyres_2:0x00000239r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.BB93_3D_tyres_2:0x00000239r;	// this rendertype as default //

		SetupTyre(245.0, 22.0, 17.0, 10.0, tcSPORT, 2.0);

		name = "BB's Sava Eskimo 245/20 R17";
