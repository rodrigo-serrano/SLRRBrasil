...
public class Sport_contact_15 extends Tyre
{
	public Sport_contact_15( int id )
	{
		...
		render_types[10] = parts.pneus:0x9Dr;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.pneus:0x9Dr;	// this rendertype as default //

		SetupTyre(245.0, 16.0, 15.0, 10.0, tcSPORT, 2.0);

		name = "BB's Continental Sport Contact 245/20 R15";
