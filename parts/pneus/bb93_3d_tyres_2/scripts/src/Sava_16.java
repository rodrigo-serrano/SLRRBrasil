...
public class Sava_16 extends Tyre
{
	public Sava_16( int id )
	{
		...
		render_types[10] = parts.BB93_3D_tyres_2:0x00000235r;	// for 10.0 inch wide rims //
		...
		render_types[21] = parts.BB93_3D_tyres_2:0x00000235r;	// this rendertype as default //

		SetupTyre(215.0, 23.0, 16.0, 10.0, tcSPORT, 2.0);

		name = "BB's Sava Eskimo 215/25 R16";
