...
public class LDelta_B extends Tyre
{
	public LDelta_B ( int id )
	{
		tyre_size_label = "175/35 R16";

		render_types[0]  = 0;		// for  5.0 inch wide rims //
		render_types[1]  = parts.lord_delta_pack:0x412r;		// for  5.5 inch wide rims //
		render_types[2]  = parts.lord_delta_pack:0x412r;		// for  6.0 inch wide rims //
		...
		render_types[21] = parts.lord_delta_pack:0x412r;	// this rendertype as default //

		SetupTyre(175.0, 35.0, 16.0, 6.0, tcSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(175.0, 35.0, 16.0, rim.rim_width, tcSPORT);
