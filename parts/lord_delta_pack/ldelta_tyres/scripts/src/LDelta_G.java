...
public class LDelta_G extends Tyre
{
	public LDelta_G ( int id )
	{
		...
		render_types[5]  = parts.lord_delta_pack:0x417r;		// for  7.5 inch wide rims //
		...
		render_types[21] = LDelta_Tyres:0x00000016r;	// this rendertype as default //

		SetupTyre(275.0, 60.0, 22.0, 9.0, tcSTREET, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(275.0, 60.0, 22.0, rim.rim_width, tcSTREET);
