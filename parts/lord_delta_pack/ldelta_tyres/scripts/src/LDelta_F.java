...
public class LDelta_F extends Tyre
{
	public LDelta_F ( int id )
	{
		tyre_size_label = "185/65 R14";

		render_types[0]  = 0;		// for  5.0 inch wide rims //
		render_types[1]  = parts.lord_delta_pack:0x416r;		// for  5.5 inch wide rims //
		render_types[2]  = parts.lord_delta_pack:0x416r;		// for  6.0 inch wide rims //
		...
		render_types[21] = parts.lord_delta_pack:0x416r;	// this rendertype as default //

		SetupTyre(185.0, 65.0, 14.0, 5.5, tcDRAGRADIAL, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(185.0, 65.0, 14.0, rim.rim_width, tcDRAGRADIAL);
