...
public class LDelta_J extends Tyre
{
	public LDelta_J ( int id )
	{
		tyre_size_label = "185/65 R14";

		render_types[0]  = 0;		// for  5.0 inch wide rims //
		render_types[1]  = parts.lord_delta_pack:0x41Ar;		// for  5.5 inch wide rims //
		render_types[2]  = parts.lord_delta_pack:0x41Ar;		// for  6.0 inch wide rims //
		...
		render_types[21] = parts.lord_delta_pack:0x41Ar;	// this rendertype as default //
