...
public class slick extends Tyre
{
	public slick ( int id )
	{
		...
		render_types[1]  = parts.lord_delta_pack:0x430r;		// for  5.5 inch wide rims //
		render_types[2]  = parts.lord_delta_pack:0x430r;		// for  6.0 inch wide rims //
		...
		SetupTyre(175.0, 35.0, 16.0, 6.0, tcDRAGRADIAL, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(175.0, 35.0, 16.0, rim.rim_width, tcDRAGRADIAL);
