...
public class LDelta_C extends Tyre
{
	public LDelta_C ( int id )
	{
		tyre_size_label = "135/50 R14";

		render_types[0]  = parts.lord_delta_pack:0x413r;		// for  5.0 inch wide rims //
		...
		render_types[21] = parts.lord_delta_pack:0x413r;	// this rendertype as default //

		SetupTyre(135.0, 50.0, 14.0, 6.0, tcSPORT, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(135.0, 50.0, 14.0, rim.rim_width, tcSPORT);
