...
public class LDelta_H extends Tyre
{
	public LDelta_H ( int id )
	{
		tyre_size_label = "275/60 R22";
		...
		render_types[5]  = parts.lord_delta_pack:0x418r;		// for  7.5 inch wide rims //
		...
		render_types[21] = LDelta_Tyres:0x00000017r;	// this rendertype as default //

		SetupTyre(275.0, 60.0, 22.0, 9.0, tcDRAGRADIAL, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(275.0, 60.0, 22.0, rim.rim_width, tcDRAGRADIAL);
