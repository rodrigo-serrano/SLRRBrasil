...
public class LDelta_A extends Tyre
{
	public LDelta_A ( int id )
	{
		tyre_size_label = "185/65 R14";

		render_types[0]  = 0;		// for  5.0 inch wide rims //
		render_types[1]  = parts.lord_delta_pack:0x411r;		// for  5.5 inch wide rims //
		render_types[2]  = parts.lord_delta_pack:0x411r;		// for  6.0 inch wide rims //
		...
		render_types[21] = parts.lord_delta_pack:0x411r;	// this rendertype as default //

		SetupTyre(185.0, 65.0, 14.0, 5.5, tcSTREET, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(185.0, 65.0, 14.0, rim.rim_width, tcSTREET);
