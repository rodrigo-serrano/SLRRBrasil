...
public class LDelta_E extends Tyre
{
	public LDelta_E ( int id )
	{
		tyre_size_label = "175/35 R16";

		render_types[0]  = 0;		// for  5.0 inch wide rims //
		render_types[1]  = parts.lord_delta_pack:0x415r;		// for  5.5 inch wide rims //
		render_types[2]  = parts.lord_delta_pack:0x415r;		// for  6.0 inch wide rims //
		...
		render_types[21] = parts.lord_delta_pack:0x415r;	// this rendertype as default //

		SetupTyre(175.0, 35.0, 16.0, 6.0, tcSTREET, 2.0);
	...
	public void updatevariables()
	{
		...
		if (rim)
		{
			...
			SetupTyre(175.0, 35.0, 16.0, rim.rim_width, tcSTREET);
