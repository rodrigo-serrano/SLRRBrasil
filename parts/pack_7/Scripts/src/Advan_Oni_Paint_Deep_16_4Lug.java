package java.game.parts.pack_7;
...
public class Advan_Oni_Paint_Deep_16_4Lug extends Wheel
{
	float f_offset, default_offset, old_offset, diameter, width;

	public Advan_Oni_Paint_Deep_16_4Lug ( int id )
	{
		name = "Roda Advan Oni Deep Pintavel 16x10";
