...
{
	final static String MapName = "Garagem";
	final static String MapDescription = "\n A Garagem do Clube Verde \n \n Voce pode usar esta garagem para tirar belas fotos.";
	final static String MapAuthor = "Autor: Mike Shinoda e Andy Oliver";
